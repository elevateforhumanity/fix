# CareerSafe - OSHA Training & Workplace Safety
...
- ⚠️ Full HAZMAT training NOT available through CareerSafe
...
**⚠️ Note:** This is a REFRESHER course only. Initial HAZWOPER training (24-hour or 40-hour) must be completed elsewhere.
...
- Anyone with potential blood exposure

**OSHA Required:** For employees with occupational exposure to blood
...
## 💰 Pricing (Estimated - Awaiting Quote)
...
- Bloodborne Pathogens: ~$20-30 per seat

**Bundle Pricing:** Additional discounts for multiple courses

**⚠️ Note:** Awaiting official quote from CareerSafe sales team
...
- **Fall Protection** (3 hours) - check CareerSafe catalog
- Electrical safety
...
### Email Template: OSHA Training Requirement

```
Subject: Required: OSHA 10-Hour Safety Training

Dear [Student Name],

As part of your [Program Name] training, you are REQUIRED to complete OSHA 10-Hour Safety Training.
...
WHEN:
Week 1 of your program
Complete within first 30 days

WHERE:
100% online, self-paced
Access provided via CareerSafe portal

HOW LONG:
10 hours (can be completed in 2-3 days)
...
- Printable certificate (immediate)
- DOL card mailed within 90 days

WHY IT MATTERS:
- Required by OSHA for many jobs
- Demonstrates safety commitment
- Makes you more employable
- Protects you and coworkers
- Industry standard

NEXT STEPS:
1. You'll receive login credentials within 24 hours
2. Complete training at your own pace
3. Pass final exam (80% required)
4. Download certificate
5. Receive DOL card in mail
...
- [ ] **Review Group Management Guide:** https://www.careersafeonline.com/support/group-mgmt-support-guide
- [ ] Explore available courses in catalog
...
- [x] Account created and activated
- [x] Organization setup complete
- [ ] **Read QuickStart Guide:** https://www.careersafeonline.com/support/quick-start-guide
...
- [ ] Purchase course seats (OSHA 10-Hour)
- [ ] Request welcome letter for DWD
...
- [ ] Verify DOL cards received (90 days)
...
4. **Explore course catalog** in admin dashboard
5. **Contact CareerSafe** for:
   - Pricing quote for seats
   - Welcome letter for Department of Workforce Development
...
9. **Update curriculum** (add OSHA 10 to Week 1 of all programs)
...
14. **Verify DOL cards** (mailed within 90 days)
...
- Partnership verification letter for DWD
...
4. ✅ Certiport (Technology)
5. ✅ VITA (Tax Preparation)
6. ✅ HSI (CPR/First Aid/Safety)
7. ✅ **CareerSafe (OSHA Training)** - NEW!

**Elevate for Humanity provides comprehensive workforce development with industry-recognized certifications!** 🚀
