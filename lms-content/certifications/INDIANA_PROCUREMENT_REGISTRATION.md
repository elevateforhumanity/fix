# Indiana Department of Administration - Procurement Registration
...
## 🎖️ What is Indiana Procurement Registration?
...
- Access state purchasing system
...
- ✅ Indiana Veteran Owned Small Business Enterprise (IVOSBE)
...
### 2. Division of Supplier Diversity Certifications
...
- ✅ Marketing materials
- ✅ Website (state contracting page)
- ✅ Email signatures
...
- MBE Certification (once obtained)
- State contracting capability
...
- Contact information
- Bidder ID: 0000067741
- Certifications (Buy Indiana, MBE, etc.)
- Indiana presence and commitment
...
**Total:** 3 Business Certifications + 8 Training Partnerships = 11 Major Credentials
...
- Respond to state communications
...
**Elevate for Humanity is now positioned to pursue state contracting opportunities and expand its impact through Indiana government partnerships!** 🏛️✨

**With federal (SAM.gov), state (Indiana), and business (ByBlack) certifications, you have comprehensive access to government contracting opportunities!** 🚀
