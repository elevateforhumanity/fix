# Complete Training & Certification Portfolio
...
**Documentation:** `/lms-content/milady-rise/`
...
**Documentation:** `/lms-content/nrf-rise-up/`
...
**Documentation:** `/lms-content/certiport/`
...
**Documentation:** `/lms-content/vita-tax-site/`
...
**Documentation:** `/lms-content/hsi-safety/`
...
- OSHA 30-Hour Construction (DOL Card)
- Bloodborne Pathogens
...
**Documentation:** `/lms-content/careersafe-osha/`
...
- ✅ HSI Adult CPR/AED
- ✅ HSI First Aid
- ✅ CareerSafe Confined Space (HVAC)
- ✅ CareerSafe Lockout/Tagout (HVAC)
...
### Email Template: Certification Requirements

```
Subject: Your Industry Certifications - Included in Your Program!

Dear [Student Name],

Congratulations on enrolling in [Program Name]! As part of your training, you will earn multiple industry-recognized certifications at NO ADDITIONAL COST.

YOUR CERTIFICATIONS:
✅ Job Readiness Initiative (JRI) - 6 badges
✅ OSHA 10-Hour Safety Card (DOL issued)
✅ CPR/AED Certification (2-year)
✅ First Aid Certification (2-year)
✅ [Program-specific certifications]

WHY IT MATTERS:
- Required by employers
- Increases your starting wage
- Demonstrates your skills
- Makes you more competitive
- Protects your safety

WHEN YOU'LL EARN THEM:
Week 1: OSHA 10-Hour, CPR/AED, First Aid
Week 2-4: JRI Badges
Throughout program: Specialized certifications
...
ALL CERTIFICATIONS ARE INCLUDED IN YOUR TUITION!
...
- [ ] Set up certification tracking system
- [ ] Train staff on all platforms
