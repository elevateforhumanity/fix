...
export const PROGRAMS: Program[] = [
  {
    ...
    heroImage: "/images/pages/comp-cta-programs.jpg",
    cardImage: "/images/pages/comp-cta-programs.jpg",
  ...
  },
  {
    ...
    cardImage: "/images/pages/comp-highlights-success.jpg",
    heroImage: "/images/pages/comp-highlights-success.jpg",
  ...
  },
  {
    ...
    story: {
      ...
      theProblem: "It's hard to find a career path that feels meaningful and actually pays—especially without support.",
