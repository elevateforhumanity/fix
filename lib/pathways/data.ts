...
export const PATHWAYS: Pathway[] = [
  ...
  },
  {
    ...
    ctaHref: '/programs/technology/it-support',
    stages: [
      { stage: 1, title: 'Eligibility Screening', description: 'Indiana Career Connect registration, WIOA/JRI eligibility determination. Remote-friendly intake.', duration: '1–2 weeks' },
      { stage: 2, title: 'Technical Training', description: 'Hardware/software troubleshooting, network configuration, operating systems (Windows, Linux, macOS), cloud computing basics.', duration: '8–12 weeks' },
      { stage: 3, title: 'CompTIA A+ Exam', description: 'CompTIA A+ certification exam (Core 1 + Core 2). Exam prep and practice tests included.', duration: '1–2 days' },
      ...
      { stage: 5, title: 'Advancement', description: 'CompTIA Network+ → Security+ → CySA+ pathway. Cybersecurity analyst, systems administrator roles.' },
    ],
  },
  {
    slug: 'cybersecurity',
    ...
    credentialIssuer: 'CompTIA',
    ctaHref: '/programs/technology/cybersecurity',
    stages: [
      { stage: 1, title: 'Eligibility Screening', description: 'Indiana Career Connect registration, WIOA/JRI eligibility. CompTIA A+ or equivalent experience recommended.', duration: '1–2 weeks' },
      { stage: 2, title: 'Security Training', description: 'Network security, threat analysis, vulnerability assessment, incident response, cryptography, compliance frameworks.', duration: '12–16 weeks' },
      { stage: 3, title: 'CompTIA Security+ Exam', description: 'CompTIA Security+ certification exam. Exam prep and practice tests included.', duration: '1 day' },
      ...
      { stage: 5, title: 'Advancement', description: 'CySA+, CASP+, CISSP pathway. SOC analyst, penetration tester, security architect roles.' },
    ],
  },
  {
    slug: 'welding',
