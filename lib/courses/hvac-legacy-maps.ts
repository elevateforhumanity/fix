/**
 * HVAC legacy slug→UUID maps.
 *
 * Used ONLY by:
 *   - app/hvac/lesson/[lessonId]/page.tsx  (standalone CSV-driven HVAC course)
 *   - app/api/courses/[courseId]/lessons/public/route.ts  (legacy fallback API)
 *   - app/programs/hvac-technician/course/HvacCourseHome.tsx
 *
 * The LMS lesson player (app/lms/...) does NOT use these maps.
 * HvacLessonVideo receives the DB UUID (lessonId) directly.
 *
 * Do not import this file from any new LMS code.
 */

/** Maps definition lesson ID (e.g. 'hvac-01-01') → deterministic UUID */
export const HVAC_LESSON_UUID: Record<string, string> = {
  ...
  'hvac-06-09': 'e248b5a0-7ec4-5220-a4bf-dcb9ceba54ef',
  'hvac-06-10': '81a203f4-f941-5a12-ac3f-8eff4218c3c3',
  'hvac-06-11': 'bbb8a29f-2664-5bb3-a7e8-d3ab16f090a7',
  'hvac-06-12': '3e8efaab-3b5b-51fe-ad18-40c1e5c7febd',
...
export const HVAC_MODULE_FIRST_LESSON: Record<string, string> = {
...
export const HVAC_FIRST_LESSON_ID = '2f172cb2-4657-5460-9b93-f9b062ad8dd2';

/** Deterministic module UUIDs matching the SQL migration */
export const HVAC_MODULE_UUID: Record<string, string> = {
  'hvac-01': 'a1000001-0001-5000-8000-000000000001',
  'hvac-02': 'a1000001-0002-5000-8000-000000000001',
  'hvac-03': 'a1000001-0003-5000-8000-000000000001',
  'hvac-04': 'a1000001-0004-5000-8000-000000000001',
  'hvac-05': 'a1000001-0005-5000-8000-000000000001',
  'hvac-06': 'a1000001-0006-5000-8000-000000000001',
  'hvac-07': 'a1000001-0007-5000-8000-000000000001',
  'hvac-08': 'a1000001-0008-5000-8000-000000000001',
  'hvac-09': 'a1000001-0009-5000-8000-000000000001',
  'hvac-10': 'a1000001-0010-5000-8000-000000000001',
  'hvac-11': 'a1000001-0011-5000-8000-000000000001',
  'hvac-12': 'a1000001-0012-5000-8000-000000000001',
  'hvac-13': 'a1000001-0013-5000-8000-000000000001',
  'hvac-14': 'a1000001-0014-5000-8000-000000000001',
  'hvac-15': 'a1000001-0015-5000-8000-000000000001',
  'hvac-16': 'a1000001-0016-5000-8000-000000000001',
};
