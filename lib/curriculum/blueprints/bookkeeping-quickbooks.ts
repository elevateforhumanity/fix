...
export const bookkeepingQuickbooksBlueprint: CredentialBlueprint = {
  ...
  credentialTitle: 'Intuit QuickBooks Online Certified User + Intuit Certified Bookkeeping Professional',
  state: 'federal',
  ...
  modules: [
    // ── Module 1 ─────────────────────────────────────────────────────────────
    {
      ...
      lessons: [
        ...
        { slug: 'bk-equity-owners-equity',              title: 'Equity, Owner\'s Equity, and Retained Earnings',   order: 7, domainKey: 'fundamentals' },
        { slug: 'bk-accrual-vs-cash-basis',             title: 'Accrual vs. Cash Basis Accounting',                order: 8, domainKey: 'fundamentals' },
        { slug: 'bk-fundamentals-checkpoint',           title: 'Module 1 Checkpoint Quiz',                         order: 9, domainKey: 'fundamentals' },
      ],
    },
    ...
    // MOS Excel removed — not an Intuit exam domain.
    {
      ...
      lessons: [
        { slug: 'bk-qbocu-exam-overview',             title: 'QuickBooks Online Certified User (QBOCU) Exam Overview',          order: 1, domainKey: 'certification' },
        { slug: 'bk-icbp-exam-overview',              title: 'Intuit Certified Bookkeeping Professional (ICBP) Exam Overview',   order: 2, domainKey: 'certification' },
        { slug: 'bk-exam-objectives-domains',         title: 'Exam Domains and Objectives: Both Certifications',                order: 3, domainKey: 'certification' },
        { slug: 'bk-practice-exam-qbocu',             title: 'Practice Exam: QBOCU Simulation',                                 order: 4, domainKey: 'certification' },
        { slug: 'bk-practice-exam-icbp',              title: 'Practice Exam: ICBP Simulation',                                  order: 5, domainKey: 'certification' },
        { slug: 'bk-reviewing-weak-areas',            title: 'Reviewing Weak Areas',                                            order: 6, domainKey: 'certification' },
        { slug: 'bk-career-pathways-bookkeeping',     title: 'Career Pathways in Bookkeeping',                                  order: 7, domainKey: 'certification' },
        // partner_exam_code values match Certiport exam identifiers
        { slug: 'bk-qbocu-certification-exam',        title: 'QuickBooks Online Certified User Exam',                           order: 8, domainKey: 'certification' },
        { slug: 'bk-icbp-certification-exam',         title: 'Intuit Certified Bookkeeping Professional Exam',                  order: 9, domainKey: 'certification' },
      ],
    },
  ],
