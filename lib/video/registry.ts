...
export const VIDEO_REGISTRY: Record<string, VideoRecord> = {
  'hero-home': {
    ...
    thumbnail_url: '/images/pages/comp-highlights-success.jpg',
    duration: 'PT1M30S',
  ...
  'cdl-hero': {
    ...
    thumbnail_url: '/images/pages/comp-pathway-trades.jpg',
    duration: 'PT50S',
    upload_date: '2025-01-01',
  ...
  'programs-overview': {
    ...
    thumbnail_url: '/images/pages/comp-cta-programs.jpg',
    duration: 'PT30S',
    upload_date: '2025-01-01',
    category: 'Overview',
    page_slugs: ['/programs'],
  ...
  'training-providers': {
    ...
    thumbnail_url: '/images/pages/comp-cta-training.jpg',
    duration: 'PT1M10S',
    upload_date: '2025-01-01',
    category: 'About',
  ...
  'getting-started': {
    ...
    thumbnail_url: '/images/pages/comp-home-hero.jpg',
    duration: 'PT35S',
    upload_date: '2025-01-01',
    category: 'How To',
  ...
  'demo-lms-overview': {
    ...
    thumbnail_url: '/images/pages/demos-hero.jpg',
    duration: 'PT15M',
    upload_date: '2025-01-01',
    category: 'Demo',
    page_slugs: ['/demos'],
