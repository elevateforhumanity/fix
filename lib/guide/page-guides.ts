    ...
    messages: [
      {
        id: 'welcome',
        type: 'welcome',
        message: "These are our platform licenses - this is how schools, training providers, and workforce agencies run their programs using our technology.",
      },
      {
        id: 'explain',
        type: 'explain',
        message: "Core License ($4,999) is for getting started. School License ($15,000) is our most popular - includes white-label branding and WIOA compliance. Enterprise ($50,000) is for multi-site organizations.",
      },
      {
        id: 'how-to',
        type: 'how-to',
        message: "Here's how it works: You buy a license, we set up your branded platform, you start enrolling students. Most providers are live within 2 weeks.",
      },
      {
        id: 'tip',
        type: 'tip',
        message: "The math: One WIOA-funded cohort of 10 students = $50,000+ revenue. The School License pays for itself with your first cohort.",
        action: { label: 'Try Free Demo', href: '/demo' },
      },
    ],
    quickTips: [
      'School License is most popular for training providers',
      'All licenses include lifetime updates',
      'WIOA compliance is built into School & Enterprise',
    ],
  },
