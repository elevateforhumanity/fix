  ...
  workkeys: {
    ...
    exams: [
      ...
      },
      {
        ...
        description: 'Measures the ability to write a clear, organized, and professional response to a workplace scenario — such as a memo, email, or report. Scored on focus, organization, development, and grammar. Required for Silver NCRC and above.',
        ncrcLevel: 'Silver (3–4) · Gold (5) · Platinum (6)',
        durationMinutes: 30,
        questionCount: 1,
      },
      {
        name: 'National Career Readiness Certificate (NCRC)',
        description: 'Earned by completing all three WorkKeys assessments (Applied Math, Workplace Documents, Business Writing). The NCRC level — Bronze, Silver, Gold, or Platinum — is determined by the lowest score across the three tests. Recognized by employers, workforce agencies, and state governments as proof of job readiness.',
