...
export class XAPIClient {
  ...
  createActor(userId: string, userName: string): XAPIActor {
    return {
      mbox: `mailto:${userId}@elevateforhumanity.institute`,
      name: userName,
      objectType: 'Agent',
    };
  }
  ...
  async trackCourseStarted(
    ...
    await this.sendStatement({
      ...
      object: {
        id: `https://elevateforhumanity.institute/courses/${courseId}`,
        definition: {
  ...
  async trackLessonCompleted(
    ...
    await this.sendStatement({
      ...
      object: {
        id: `https://elevateforhumanity.institute/lessons/${lessonId}`,
        definition: {
  ...
  async trackQuizAttempt(
    ...
    await this.sendStatement({
      ...
      object: {
        id: `https://elevateforhumanity.institute/quizzes/${quizId}`,
        definition: {
          name: { 'en-US': quizName },
  ...
  async trackVideoWatched(
    ...
    await this.sendStatement({
      ...
      object: {
        id: `https://elevateforhumanity.institute/videos/${videoId}`,
        definition: {
