...
Ready-to-use templates for different scenarios. Fill in the bracketed sections.

---

## Template 1: Standard DMCA Takedown (Hosting Provider)
...
These watermarks prove the content was copied from our original site.
...
Please remove or disable access to the infringing material within 24 hours.
...
## Template 2: Domain Registrar Complaint

```
Subject: Copyright Infringement - Domain Used for Piracy
...
EVIDENCE:
1. Side-by-side comparison: [attach screenshots]
2. Our watermarks found in their source code
...
Use at: https://www.google.com/webmasters/tools/legal-removal-request

```
Type of request: Copyright infringement (DMCA)

I am the copyright owner.

Original work URL: https://www.elevateforhumanity.org/[specific-page]
...
Signature: Elizabeth L. Greene
Date: [DATE]
```

---

## Template 4: Cease and Desist Letter (Direct to Infringer)
...
To: [Infringer Name/Website Owner]
    [Their Email if known]

Re: Copyright Infringement - Immediate Removal Required
...
ORIGINAL WORK:
Our original website is located at https://www.elevateforhumanity.org
Copyright © 2024-2025 Elevate for Humanity. All Rights Reserved.

DEMAND:
You must IMMEDIATELY:
1. Remove ALL copied content from your website
2. Delete any copies of our materials in your possession
3. Confirm in writing that you have complied

DEADLINE: You have 48 HOURS from receipt of this notice to comply.

CONSEQUENCES OF NON-COMPLIANCE:
If you fail to comply, we will:
1. File DMCA takedown notices with your hosting provider
2. Report your site to search engines for removal
...
## Template 5: Payment Processor Report (Stripe/PayPal)

```
Subject: Copyright Infringement - Merchant Selling Stolen Content
...
Website: [infringing-site.com]
[Any merchant ID if visible]
...
EVIDENCE:
- Screenshots attached showing copied content
- Our watermarks visible in their source code
...
## Template 6: Social Media Platform Report

For Facebook, Instagram, Twitter/X, LinkedIn:

```
Report Type: Intellectual Property / Copyright

I am reporting content that infringes my copyright.

Original content: https://www.elevateforhumanity.org
...
Electronic signature: Elizabeth L. Greene
Date: [DATE]
```
