    ...
    <>
      ...
      <div className="w-full h-full bg-white border-b border-gray-200 shadow-sm site-header">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between gap-4 relative">
          ...
          >
            <div className="relative h-10 w-10 sm:h-12 sm:w-12 shrink-0 overflow-hidden bg-gradient-to-br from-orange-500 to-orange-600 rounded-lg shadow-md">
              <Image
                src="/logo-small.png"
                ...
                height={48}
                priority
                className="h-full w-full object-contain transition-opacity hover:opacity-80 p-1"
