      ...
      <div className="mx-auto max-w-6xl px-4 py-10">
        <div className="grid gap-8 md:grid-cols-4">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-700">{siteConfig.description}</p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-slate-700">
              ...
              <li><Link href="/funding" className="hover:text-slate-900">Funding</Link></li>
              <li><Link href="/supersonic-fast-cash" className="hover:text-slate-900">Supersonic Fast Cash</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-slate-700">
              ...
              <li><Link href="/legal" className="hover:text-slate-900">Legal</Link></li>
              <li><Link href="/legal/privacy" className="hover:text-slate-900">Privacy Policy</Link></li>
              <li><Link href="/legal/enrollment-agreement" className="hover:text-slate-900">Enrollment Agreement</Link></li>
            </ul>
          </div>
        </div>
