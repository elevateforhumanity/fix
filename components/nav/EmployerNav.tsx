 ...
 * EMPLOYER NAVIGATION
 *
 * Sidebar navigation for employers.
 * Focus: Job postings, applications, apprenticeships, hiring.
 */
...
const navigation: (NavItem | NavGroup)[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Post New Job', href: '/employer/jobs/new', icon: Briefcase },
      { name: 'Archived', href: '/employer/jobs/archived', icon: Briefcase },
    ],
  },
  {
    name: 'Applications',
    icon: Users,
    children: [
      { name: 'All Applications', href: '/employer/applications', icon: Users },
      {
        name: 'Pending Review',
        href: '/employer/applications/pending',
        icon: Users,
      },
      {
        name: 'Interviews',
        href: '/employer/applications/interviews',
        icon: Users,
      },
    ],
  },
  {
    ...
    children: [
      ...
      { name: 'Apprentices', href: '/employer/apprentices', icon: Users },
    ],
  },
  {
      ...
      <div className="mb-8">
        <Link href="/" aria-label="Link" className="flex items-center gap-2">
          ...
          <div className="flex flex-col">
            ...
            <div className="text-xs text-gray-400 -mt-1">Employer Portal</div>
          </div>
        </Link>
      </div>
