...
export const NAV_ITEMS = [
  ...
  },
  {
    ...
    href: '/program-holder',
    subItems: [
      { name: '— Overview —', href: '/program-holder', isHeader: true },
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: '— Partner Salons —', href: '/partners/cosmetology-apprenticeship', isHeader: true },
      { name: 'Become a Partner Salon', href: '/partners/cosmetology-apprenticeship' },
      { name: 'Partner Salon Application', href: '/partners/cosmetology-apprenticeship/apply' },
      { name: 'Sign MOU', href: '/partners/cosmetology-apprenticeship/sign-mou' },
