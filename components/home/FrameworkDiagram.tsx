      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-4 gap-8 max-w-6xl mx-auto">
          ...
          <div className="relative">
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">1. Apply</h3>
          ...
          <div className="relative">
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">2. Train</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
          ...
          <div className="relative">
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">3. Certify</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
          ...
          <div className="relative">
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">4. Work</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="text-center">
            ...
            <div className="text-gray-600">Free Training Available</div>
          </div>
          <div className="text-center">
