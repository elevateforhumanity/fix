...
BEGIN
  ...
  IF certiport_id IS NULL THEN
    RAISE EXCEPTION 'Partner providers not found. Run STEP 1 first!';
  END IF;
  ...
  (certiport_id, 'MOS: Word Associate (Office 2019)', 'Fundamental Word skills for professional document creation', 'Microsoft Office', 117, 164, 40, true),
