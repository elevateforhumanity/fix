...
export const orientationConfigs: Record<string, OrientationProgramConfig> = {
  ...
  'cosmetology-apprenticeship': {
    ...
    totalHours: 1500,
    hoursLabel: '1,500 hours',
    ojtDescription: 'Work in a licensed salon under a mentor cosmetologist. Learn real skills with real clients.',
    rtiDescription: 'Complete Milady theory courses online. Learn hair, skin, nail techniques, sanitation, and business skills.',
    tuition: {
      total: 4500,
      setupFeePercent: 35,
      paymentFrequency: 'Billed every Friday',
