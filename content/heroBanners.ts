...
Apply online in minutes. No cost to apply. No obligation. Just the first step toward a career that pays.`,
  ...
  mission: {
    ...
    primaryCta: { label: 'Our Story', href: '/about#who-we-are' },
    secondaryCta: { label: 'Start Training', href: '/start', variant: 'secondary' },
  ...
  funding: {
    ...
    primaryCta: { label: 'Check My Eligibility', href: '/start' },
    secondaryCta: { label: 'View Programs', href: '/programs', variant: 'secondary' },
  ...
  enrollment: {
    ...
    primaryCta: { label: 'Apply Now', href: '/apply' },
    secondaryCta: { label: 'Check Eligibility', href: '/start', variant: 'secondary' },
  ...
  'student-support': {
    ...
    primaryCta: { label: 'Apply Now', href: '/start' },
