...
const heroBanners: Record<string, HeroBannerConfig> = {
  ...
  about: {
    ...
    videoSrcMobile: '/videos/about-mission.mp4',
  ...
  'funding-how-it-works': {
    ...
    videoSrcDesktop: '/videos/getting-started-hero.mp4',
    posterImage: '/hero-images/wioa-hero.jpg',
    videoSrcMobile: '/videos/getting-started-hero.mp4',
  ...
  healthcare: {
    ...
    secondaryCta: { label: 'Check Eligibility', href: '/check-eligibility', variant: 'secondary' },
    trustIndicators: [
  ...
  store: {
    ...
    videoSrcMobile: '/videos/store-whitelabel-narrated.mp4',
    posterImage: '/hero-images/technology-hero.jpg',
...
Try the live demo — no signup, no time limit. Every screen is clickable. Search students, run reports, review applications, browse candidates. See exactly what your staff and students will use every day.`,
  ...
  programs: {
    ...
    videoSrcMobile: '/videos/programs-overview-video-with-narration.mp4',
...
Apply online in minutes. No cost to apply. No obligation. Just the first step toward a career that pays.`,
  ...
  learner: {
    ...
    videoSrcMobile: '/videos/student-portal-hero.mp4',
  ...
  'cosmetology-apprenticeship': programBanner('cosmetology-apprenticeship', {
    ...
    posterImage: '/images/pages/cosmetology-hero.jpg',
  ...
  'nail-technician-apprenticeship': programBanner('nail-technician-apprenticeship', {
    ...
    secondaryCta: { label: 'Find a Host Salon', href: '/partners/nail-technician-apprenticeship/apply', variant: 'secondary' },
  ...
  'culinary-apprenticeship': programBanner('culinary-apprenticeship', {
    ...
    posterImage: '/images/pages/admin-ferpa-training-hero.jpg',
    voiceoverSrc: '/audio/heroes/barber.mp3',
    microLabel: 'DOL Registered Apprenticeship',
  ...
  'esthetician': programBanner('esthetician', {
    ...
    primaryCta: { label: 'Apply Now', href: '/programs/esthetician/apply' },
    secondaryCta: { label: 'Check Eligibility', href: '/check-eligibility', variant: 'secondary' },
  ...
  'bookkeeping': programBanner('bookkeeping', {
    ...
    voiceoverSrc: '/audio/heroes/bookkeeping.mp3',
    ...
    belowHeroSubheadline: 'Small business accounting, accounts payable, receivable, and payroll. Prepare for the QuickBooks Certified User exam. Free with WIOA or Next Level Jobs funding for eligible Indiana residents.',
    ...
    trustIndicators: ['Free with WIOA + Next Level Jobs', 'QuickBooks Certified User cert', 'Accounts payable, receivable & payroll', 'Bookkeepers earn $38K–$52K'],
    transcript: 'Train for QuickBooks Certified User certification in 5 weeks, building skills in small business accounting, accounts payable, accounts receivable, and payroll processing. Bookkeepers commonly earn $38,000 to $52,000. Free with WIOA or Next Level Jobs funding for eligible Indiana residents.',
  ...
  'business-administration': programBanner('business-administration', {
    ...
    secondaryCta: { label: 'Check Eligibility', href: '/check-eligibility', variant: 'secondary' },
    trustIndicators: ['Free with WIOA + Next Level Jobs', 'Microsoft Office Specialist', 'Certiport ESB cert', 'Business admin pay $38K–$55K'],
  ...
  'business': {
    ...
    videoSrcMobile: '/videos/partner-business.mp4',
    voiceoverSrc: '/audio/heroes/business.mp3',
    microLabel: 'Business & Finance Programs',
    belowHeroHeadline: 'Launch a business career — certifications in 5–10 weeks.',
    belowHeroSubheadline: 'Tax preparation, bookkeeping, office administration, entrepreneurship, and project management. Certiport, IRS, and QuickBooks credentials. Free with WIOA or Next Level Jobs for eligible Indiana residents.',
    primaryCta: { label: 'Apply Now', href: '/apply?program=business' },
    secondaryCta: { label: 'Check Eligibility', href: '/check-eligibility', variant: 'secondary' },
    trustIndicators: ['Free with WIOA + Next Level Jobs', 'Certiport MOS + ESB + QuickBooks', 'IRS PTIN credential', 'Earn $35K–$55K'],
    transcript: 'Launch a business career with Elevate for Humanity. Programs in tax preparation, bookkeeping, office administration, entrepreneurship, and project management. Earn Certiport, IRS, and QuickBooks credentials in 5 to 10 weeks. Free with WIOA or Next Level Jobs funding for eligible Indiana residents.',
  ...
  mission: {
    ...
    belowHeroSubheadline: 'Free career training for those who need it most — justice-involved, low-income, veterans, and anyone facing barriers to employment.',
    primaryCta: { label: 'Our Story', href: '/about#who-we-are' },
    secondaryCta: { label: 'Start Training', href: '/check-eligibility', variant: 'secondary' },
    trustIndicators: ['Founded 2019', 'Indianapolis, Indiana', 'DOL Registered Apprenticeship Sponsor'],
    transcript: 'Elevate for Humanity exists to close the gap between people who need work and employers who need workers. Free training. Real credentials. A direct path to employment.',
    analyticsName: 'mission',
  },

  partners: {
    pageKey: 'partners',
    videoSrcDesktop: '/videos/partner-join-narrated.mp4',
    videoSrcMobile: '/videos/partner-join-narrated.mp4',
    ...
    belowHeroSubheadline: 'Workforce agencies, employers, training providers, barbershops, and reentry organizations — we build pathways together.',
    primaryCta: { label: 'Become a Partner', href: '/partners/join' },
    secondaryCta: { label: 'Sign an MOU', href: '/partners/mou', variant: 'secondary' },
    trustIndicators: ['DOL Registered Apprenticeship Sponsor', 'ETPL approved', 'WIOA partner'],
    transcript: 'Elevate partners with workforce agencies, employers, and community organizations to build training pathways that work. Join us.',
  ...
  lms: {
    ...
    videoSrcMobile: '/videos/lms-learning.mp4',
    posterImage: '/hero-images/how-it-works-hero.jpg',
    voiceoverSrc: '/audio/heroes/lms.mp3',
    microLabel: 'Student Training Portal',
    belowHeroHeadline: 'Your career training starts here.',
    belowHeroSubheadline: 'Browse programs, enroll, and earn industry credentials — all in one place.',
    primaryCta: { label: 'Browse Programs', href: '/lms/programs' },
    secondaryCta: { label: 'Sign In', href: '/login', variant: 'secondary' },
    trustIndicators: ['Industry credentials', 'Self-paced learning', 'Instructor support'],
    transcript: 'The Elevate student portal gives you access to career training programs, lesson content, and credential pathways — all in one place.',
    analyticsName: 'lms',
  },
  ...
  training: {
    ...
    belowHeroSubheadline: 'Healthcare, skilled trades, CDL, technology, barbering, and business. Most programs available at no cost to eligible Indiana residents.',
    primaryCta: { label: 'See All Programs', href: '/programs' },
    secondaryCta: { label: 'Check Eligibility', href: '/check-eligibility', variant: 'secondary' },
    trustIndicators: ['WIOA & state funding available', 'ETPL approved', 'DOL Registered Apprenticeship Sponsor'],
    transcript: 'Elevate offers career training in healthcare, skilled trades, CDL, technology, and more. Most programs are available at no cost through WIOA and state funding.',
  ...
  jri: {
    ...
    belowHeroSubheadline: 'Career pathways for justice-involved individuals — credentials, employer connections, and funding support.',
    primaryCta: { label: 'Get Started', href: '/apply?program=jri' },
    secondaryCta: { label: 'Learn More', href: '/jri#programs', variant: 'secondary' },
    trustIndicators: ['WIOA eligible', 'Reentry-focused employers', 'Record-friendly programs'],
    transcript: 'Elevate for Humanity provides career training and employer connections specifically designed for justice-involved individuals re-entering the workforce.',
    analyticsName: 'jri',
  },
  ...
  'about-team': {
    ...
    posterImage: '/hero-images/about-hero.jpg',
    microLabel: 'Our Team',
    belowHeroHeadline: 'The people behind Elevate for Humanity.',
    belowHeroSubheadline: 'Workforce professionals, educators, and community advocates committed to expanding access to career training.',
    primaryCta: { label: 'Join Our Team', href: '/careers' },
    secondaryCta: { label: 'Our Mission', href: '/mission', variant: 'secondary' },
    trustIndicators: ['Indiana-based', 'Community-driven', 'ETPL Certified'],
    transcript: 'Meet the team behind Elevate for Humanity — workforce professionals and educators committed to expanding access to career training.',
    analyticsName: 'about-team',
  },

  'about-partners': {
    pageKey: 'about-partners',
    videoSrcDesktop: '/videos/partner-join-narrated.mp4',
    videoSrcMobile: '/videos/partner-join-narrated.mp4',
    posterImage: '/hero-images/pathways-hero.jpg',
    microLabel: 'Our Partners',
    belowHeroHeadline: 'Built on strong partnerships.',
    belowHeroSubheadline: 'Employers, workforce agencies, and community organizations working together to connect Hoosiers to careers.',
    primaryCta: { label: 'Become a Partner', href: '/partners/join' },
    secondaryCta: { label: 'View Partners', href: '/partners', variant: 'secondary' },
    trustIndicators: ['WIOA Partners', 'Employer Network', 'Community Orgs'],
    transcript: 'Elevate for Humanity partners with employers, workforce agencies, and community organizations to connect Hoosiers to real careers.',
    analyticsName: 'about-partners',
  },

  blog: {
    pageKey: 'blog',
    videoSrcDesktop: '/videos/elevate-overview-with-narration.mp4',
    videoSrcMobile: '/videos/elevate-overview-with-narration.mp4',
    posterImage: '/hero-images/pathways-hero.jpg',
    microLabel: 'News & Insights',
    belowHeroHeadline: 'Workforce training news and career insights.',
    belowHeroSubheadline: 'Updates from Elevate for Humanity — program news, student success stories, and workforce development resources.',
    primaryCta: { label: 'Browse Articles', href: '/blog' },
    trustIndicators: ['Student Stories', 'Program Updates', 'Career Tips'],
    transcript: 'Stay current with workforce training news, student success stories, and career development insights from Elevate for Humanity.',
    analyticsName: 'blog',
  },

  'career-services': {
    pageKey: 'career-services',
    videoSrcDesktop: '/videos/career-services-hero.mp4',
    videoSrcMobile: '/videos/career-services-hero.mp4',
    posterImage: '/hero-images/career-services-hero.jpg',
    microLabel: 'Career Services',
    belowHeroHeadline: 'From training to employment — we stay with you.',
    belowHeroSubheadline: 'Resume building, interview prep, job placement, and ongoing career support for every Elevate graduate.',
    primaryCta: { label: 'Get Career Support', href: '/career-services/job-placement' },
    secondaryCta: { label: 'View Programs', href: '/programs', variant: 'secondary' },
    trustIndicators: ['Job Placement Support', 'Resume Coaching', 'Employer Network'],
    transcript: 'Elevate for Humanity provides career services from resume building and interview prep to job placement and ongoing support for every graduate.',
  ...
  careers: {
    ...
    posterImage: '/hero-images/pathways-hero.jpg',
    microLabel: 'Work With Us',
    belowHeroHeadline: 'Join the Elevate for Humanity team.',
    belowHeroSubheadline: 'Help us expand access to workforce training across Indiana. We\'re hiring educators, coaches, and operations staff.',
    primaryCta: { label: 'View Open Roles', href: '/careers#openings' },
    secondaryCta: { label: 'Our Mission', href: '/mission', variant: 'secondary' },
    trustIndicators: ['Mission-driven', 'Competitive pay', 'Remote-friendly roles'],
    transcript: 'Join the Elevate for Humanity team and help expand access to workforce training across Indiana.',
    analyticsName: 'careers',
  },

  'cna-waitlist': {
    pageKey: 'cna-waitlist',
    videoSrcDesktop: '/videos/cna-hero.mp4',
    videoSrcMobile: '/videos/cna-hero.mp4',
    posterImage: '/hero-images/healthcare-cat-new.jpg',
    microLabel: 'CNA Certification',
    belowHeroHeadline: 'CNA Certification — Join the Waitlist.',
    belowHeroSubheadline: 'Indiana CNA certification training is opening soon. Join the waitlist to be first in line when enrollment opens.',
    primaryCta: { label: 'Join the Waitlist', href: '/cna-waitlist#form' },
    secondaryCta: { label: 'Check Eligibility', href: '/check-eligibility', variant: 'secondary' },
    trustIndicators: ['WIOA Eligible', 'Indiana State Board', 'Employer Connections'],
    transcript: 'Indiana CNA certification training is opening soon at Elevate for Humanity. Join the waitlist to be notified when enrollment opens.',
    analyticsName: 'cna-waitlist',
  },
  ...
  contact: {
    ...
    videoSrcMobile: '/videos/elevate-overview-with-narration.mp4',
    posterImage: '/hero-images/pathways-hero.jpg',
    microLabel: 'Contact Us',
    belowHeroHeadline: 'We\'re here to help.',
    belowHeroSubheadline: 'Questions about programs, funding, enrollment, or partnerships — reach out and we\'ll respond within one business day.',
    primaryCta: { label: 'Send a Message', href: '/contact#form' },
    secondaryCta: { label: 'Call Us', href: 'tel:+13178889999', variant: 'secondary' },
    trustIndicators: ['1-business-day response', 'Indiana-based team', 'Free consultations'],
    transcript: 'Contact Elevate for Humanity with questions about programs, funding, enrollment, or partnerships. We respond within one business day.',
  ...
  donate: {
    ...
    videoSrcMobile: '/videos/graduation-success.mp4',
    posterImage: '/hero-images/pathways-hero.jpg',
    microLabel: 'Support Our Mission',
    belowHeroHeadline: 'Your donation funds a career.',
    belowHeroSubheadline: 'Every contribution helps Elevate for Humanity provide free and low-cost workforce training to Hoosiers who need it most.',
    primaryCta: { label: 'Donate Now', href: '/donate#form' },
    secondaryCta: { label: 'See Our Impact', href: '/impact', variant: 'secondary' },
    trustIndicators: ['501(c)(3) Nonprofit', 'Tax-deductible', '100% to programs'],
    transcript: 'Your donation to Elevate for Humanity funds free and low-cost workforce training for Hoosiers who need it most.',
    analyticsName: 'donate',
  },
  ...
  events: {
    ...
    videoSrcMobile: '/videos/graduation-success.mp4',
    posterImage: '/hero-images/pathways-hero.jpg',
    microLabel: 'Events & Workshops',
    belowHeroHeadline: 'Connect, learn, and grow.',
    belowHeroSubheadline: 'Orientation sessions, employer hiring events, graduation ceremonies, and community workshops — all free to attend.',
    primaryCta: { label: 'View Upcoming Events', href: '/events#calendar' },
    secondaryCta: { label: 'Apply to a Program', href: '/apply', variant: 'secondary' },
    trustIndicators: ['Free to attend', 'Employer hiring events', 'Graduation ceremonies'],
    transcript: 'Elevate for Humanity hosts orientation sessions, employer hiring events, graduation ceremonies, and community workshops — all free to attend.',
  ...
  'for-partners': {
    ...
    videoSrcMobile: '/videos/partner-join-narrated.mp4',
    posterImage: '/hero-images/pathways-hero.jpg',
    microLabel: 'For Partners',
    belowHeroHeadline: 'Partner with Indiana\'s workforce training leader.',
    belowHeroSubheadline: 'Workforce agencies, employers, and community organizations — join the Elevate network and connect your clients to real careers.',
    primaryCta: { label: 'Become a Partner', href: '/partners/join' },
    secondaryCta: { label: 'View Partner Benefits', href: '/partners', variant: 'secondary' },
    trustIndicators: ['WIOA Compliant', 'RAPIDS Tracked', 'ETPL Certified'],
    transcript: 'Partner with Elevate for Humanity to connect your clients to real career training. We are WIOA compliant, RAPIDS tracked, and ETPL certified.',
    analyticsName: 'for-partners',
  },

  'for-students': {
    pageKey: 'for-students',
    videoSrcDesktop: '/videos/hero-home.mp4',
    videoSrcMobile: '/videos/hero-home.mp4',
    posterImage: '/hero-images/pathways-hero.jpg',
    microLabel: 'For Students',
    belowHeroHeadline: 'Your career starts here.',
    belowHeroSubheadline: 'Free and funded training programs in healthcare, trades, technology, and business. Most programs complete in 4–12 weeks.',
    primaryCta: { label: 'Apply Now', href: '/apply' },
    secondaryCta: { label: 'Check Eligibility', href: '/check-eligibility', variant: 'secondary' },
    trustIndicators: ['Free for eligible students', 'Credentials in weeks', 'Job placement support'],
    transcript: 'Elevate for Humanity offers free and funded career training in healthcare, trades, technology, and business. Most programs complete in 4 to 12 weeks.',
    analyticsName: 'for-students',
  },
  ...
  founder: {
    ...
    videoSrcMobile: '/videos/about-mission.mp4',
    posterImage: '/hero-images/about-hero.jpg',
    microLabel: 'Our Founder',
    belowHeroHeadline: 'A mission rooted in community.',
    belowHeroSubheadline: 'Learn about the vision and values behind Elevate for Humanity and the founder\'s commitment to workforce equity.',
    primaryCta: { label: 'Our Mission', href: '/mission' },
    secondaryCta: { label: 'View Programs', href: '/programs', variant: 'secondary' },
    trustIndicators: ['Indiana-based', 'Community-driven', 'ETPL Certified'],
    transcript: 'Learn about the vision and values behind Elevate for Humanity and the founder\'s commitment to workforce equity in Indiana.',
    analyticsName: 'founder',
  },
  ...
  funding: {
    ...
    microLabel: 'Funding & Financial Aid',
    belowHeroHeadline: 'Training that pays for itself.',
    belowHeroSubheadline: 'WIOA, Workforce Ready Grant, Next Level Jobs, and other funding sources cover tuition for eligible Indiana residents.',
    primaryCta: { label: 'Check My Eligibility', href: '/check-eligibility' },
    secondaryCta: { label: 'View Programs', href: '/programs', variant: 'secondary' },
    trustIndicators: ['WIOA Approved', 'Next Level Jobs', 'Workforce Ready Grant'],
    transcript: 'Elevate for Humanity programs are funded through WIOA, Workforce Ready Grant, Next Level Jobs, and other sources for eligible Indiana residents.',
  ...
  news: {
    ...
    posterImage: '/hero-images/pathways-hero.jpg',
    microLabel: 'News',
    belowHeroHeadline: 'Latest from Elevate for Humanity.',
    belowHeroSubheadline: 'Program announcements, partnership news, student success stories, and workforce development updates.',
    primaryCta: { label: 'Read Latest', href: '/news#articles' },
    trustIndicators: ['Program Updates', 'Student Stories', 'Partnership News'],
    transcript: 'Stay current with the latest news from Elevate for Humanity — program announcements, partnerships, and student success stories.',
    analyticsName: 'news',
  },
  ...
  pathways: {
    ...
    videoSrcMobile: '/videos/programs-overview-video-with-narration.mp4',
    posterImage: '/hero-images/pathways-hero.jpg',
    microLabel: 'Career Pathways',
    belowHeroHeadline: 'Find your pathway to a career.',
    belowHeroSubheadline: 'Healthcare, skilled trades, technology, beauty, and business — explore credential pathways designed for Indiana\'s job market.',
    primaryCta: { label: 'Explore Pathways', href: '/pathways#sectors' },
    secondaryCta: { label: 'Apply Now', href: '/apply', variant: 'secondary' },
    trustIndicators: ['5 career sectors', 'Employer-aligned credentials', 'WIOA funded'],
    transcript: 'Explore career pathways at Elevate for Humanity in healthcare, skilled trades, technology, beauty, and business — all designed for Indiana\'s job market.',
    analyticsName: 'pathways',
  },
  ...
  press: {
    ...
    videoSrcMobile: '/videos/elevate-overview-with-narration.mp4',
    posterImage: '/hero-images/pathways-hero.jpg',
    microLabel: 'Press & Media',
    belowHeroHeadline: 'Elevate for Humanity in the news.',
    belowHeroSubheadline: 'Press releases, media coverage, and brand assets for journalists and media partners.',
    primaryCta: { label: 'Press Kit', href: '/press#kit' },
    secondaryCta: { label: 'Contact Press', href: '/contact', variant: 'secondary' },
    trustIndicators: ['Media inquiries welcome', 'Brand assets available', 'Spokespeople available'],
    transcript: 'Find press releases, media coverage, and brand assets for Elevate for Humanity. Media inquiries welcome.',
    analyticsName: 'press',
  },
  ...
  pricing: {
    ...
    posterImage: '/hero-images/pathways-hero.jpg',
    microLabel: 'Pricing',
    belowHeroHeadline: 'Transparent pricing for every pathway.',
    belowHeroSubheadline: 'Most programs are free for eligible Indiana residents. Self-pay and payment plan options available for all others.',
    primaryCta: { label: 'Check Eligibility', href: '/check-eligibility' },
    secondaryCta: { label: 'View Programs', href: '/programs', variant: 'secondary' },
    trustIndicators: ['Free for eligible students', 'Payment plans available', 'No hidden fees'],
    transcript: 'Elevate for Humanity offers transparent pricing. Most programs are free for eligible Indiana residents, with self-pay and payment plan options for others.',
  ...
  volunteer: {
    ...
    videoSrcMobile: '/videos/graduation-success.mp4',
    posterImage: '/hero-images/pathways-hero.jpg',
    microLabel: 'Volunteer',
    belowHeroHeadline: 'Give your time. Change a career.',
    belowHeroSubheadline: 'Volunteer as a mentor, mock interviewer, guest speaker, or event helper. Every hour makes a difference.',
    primaryCta: { label: 'Volunteer Now', href: '/volunteer#form' },
    secondaryCta: { label: 'Our Mission', href: '/mission', variant: 'secondary' },
    trustIndicators: ['Flexible hours', 'Remote options', 'Community impact'],
    transcript: 'Volunteer with Elevate for Humanity as a mentor, mock interviewer, guest speaker, or event helper. Every hour makes a difference.',
    analyticsName: 'volunteer',
  },
  ...
  'what-we-do': {
    ...
    belowHeroHeadline: 'Workforce training that works.',
    belowHeroSubheadline: 'Elevate for Humanity provides credential-bearing career training, employer connections, and funding navigation for Indiana residents.',
    primaryCta: { label: 'View Programs', href: '/programs' },
    secondaryCta: { label: 'Apply Now', href: '/apply', variant: 'secondary' },
    trustIndicators: ['ETPL Certified', 'DOL Registered', 'RAPIDS Tracked'],
    transcript: 'Elevate for Humanity provides credential-bearing career training, employer connections, and funding navigation for Indiana residents.',
    analyticsName: 'what-we-do',
  },

  'workforce-partners': {
    pageKey: 'workforce-partners',
    videoSrcDesktop: '/videos/training-providers-hero.mp4',
    videoSrcMobile: '/videos/training-providers-hero.mp4',
    posterImage: '/hero-images/employer-hero.jpg',
    microLabel: 'Workforce Partners',
    belowHeroHeadline: 'A workforce pipeline you can count on.',
    belowHeroSubheadline: 'Elevate for Humanity partners with WorkOne, FSSA, employers, and community organizations to deliver WIOA-compliant training at scale.',
    primaryCta: { label: 'Become a Partner', href: '/partners/join' },
    secondaryCta: { label: 'WorkOne Packet', href: '/workone-partner-packet', variant: 'secondary' },
    trustIndicators: ['WIOA Compliant', 'RAPIDS Tracked', 'ETPL Certified'],
    transcript: 'Elevate for Humanity partners with WorkOne, FSSA, employers, and community organizations to deliver WIOA-compliant workforce training at scale.',
    analyticsName: 'workforce-partners',
  },
  ...
  supersonic: {
    pageKey: 'supersonic',
    videoSrcDesktop: '/videos/supersonic-intro-narrated.mp4',
    videoSrcMobile: '/videos/supersonic-intro-narrated.mp4',
    posterImage: '/hero-images/tax-hero.jpg',
    voiceoverSrc: '/audio/heroes/supersonic.mp3',
    microLabel: 'SupersonicFastCash',
    belowHeroHeadline: 'Tax software built for speed.',
    belowHeroSubheadline: 'Professional tax preparation software for Enrolled Agents, EROs, and tax businesses. Fast refunds. Secure filing. Built for volume.',
    primaryCta: { label: 'Get Started', href: '/supersonic#pricing' },
    secondaryCta: { label: 'See Features', href: '/supersonic#features', variant: 'secondary' },
    trustIndicators: ['IRS Authorized e-File Provider', 'EFIN & PTIN ready', 'Bank products available'],
    transcript: 'SupersonicFastCash is professional tax software built for speed, volume, and compliance. Designed for Enrolled Agents and EROs who need fast refunds and secure filing.',
    analyticsName: 'supersonic',
  },
  ...
  services: {
    ...
    belowHeroSubheadline: 'From enrollment to employment: career coaching, credential prep, employer connections, and funding navigation.',
    primaryCta: { label: 'Check Eligibility', href: '/check-eligibility' },
    secondaryCta: { label: 'See Programs', href: '/programs', variant: 'secondary' },
    trustIndicators: ['WIOA & state funding', 'Career coaching included', 'Employer network'],
    transcript: 'Elevate provides end-to-end workforce services — training, credential preparation, career coaching, and employer connections — all coordinated in one system.',
  ...
  enrollment: {
    ...
    belowHeroSubheadline: 'Choose your program, confirm your funding, and begin training — often within days.',
    primaryCta: { label: 'Apply Now', href: '/apply' },
    secondaryCta: { label: 'Check Eligibility', href: '/check-eligibility', variant: 'secondary' },
    trustIndicators: ['Fast enrollment', 'Funding pre-checked', 'No upfront cost for eligible students'],
    transcript: 'Enrollment at Elevate is fast. Choose your program, confirm your funding eligibility, and start training — often within days of applying.',
    analyticsName: 'enrollment',
  },
  ...
  'how-it-works': {
    ...
    belowHeroSubheadline: 'Apply, confirm funding, complete training, earn your credential, and connect with employers.',
    primaryCta: { label: 'Start the Process', href: '/apply' },
    secondaryCta: { label: 'See Programs', href: '/programs', variant: 'secondary' },
    trustIndicators: ['Simple application', 'Funding confirmed upfront', 'Employer-connected outcomes'],
    transcript: 'Elevate makes the path to a new career straightforward. Apply, confirm your funding, complete training, earn your credential, and connect with hiring employers.',
    analyticsName: 'how-it-works',
  },
  ...
  employer: {
    ...
    belowHeroSubheadline:
      'Elevate graduates arrive trained, tested, and credentialed. Access WOTC tax credits, OJT wage reimbursement, and DOL Registered Apprenticeship sponsorship.',
    primaryCta: { label: 'Partner With Us', href: '/testing/book?type=group-testing' },
    secondaryCta: { label: 'Browse Candidates', href: '/employer/candidates', variant: 'secondary' },
    trustIndicators: [
      'WOTC tax credits up to $9,600',
      'OJT wage reimbursement',
      'DOL Registered Apprenticeship Sponsor',
      'No placement fees',
    ],
    transcript:
      'Elevate graduates are credential-ready and pre-screened. Access WOTC tax credits, OJT wage reimbursement, and Registered Apprenticeship sponsorship — all through one partner.',
  ...
  credentials: {
    ...
    belowHeroSubheadline:
      'DOL Registered Apprenticeship Sponsor. Indiana ETPL Certified. WIOA compliant. Every credential is operationally integrated, not decorative.',
    primaryCta: { label: 'View Programs', href: '/programs' },
    secondaryCta: { label: 'Verify a Credential', href: '/verify-credentials', variant: 'secondary' },
    trustIndicators: [
      'DOL Registered Apprenticeship Sponsor',
      'Indiana ETPL Certified',
      'WIOA Title I Compliant',
      'Certiport Authorized Testing Center',
    ],
    transcript:
      'Every Elevate credential is active, verifiable, and operationally integrated. DOL Registered Apprenticeship Sponsor, Indiana ETPL Certified, and WIOA compliant — four compliance tiers, three credential layers.',
  ...
  'student-support': {
    ...
    belowHeroSubheadline:
      'Academic help, financial aid, career services, and counseling — everything you need to succeed.',
    primaryCta: { label: 'Apply Now', href: '/apply' },
    secondaryCta: { label: 'Schedule Advising', href: '/student-support/schedule', variant: 'secondary' },
    trustIndicators: [
    ...
    transcript:
      'Elevate provides academic support, financial aid navigation, career placement, and counseling services — all included for enrolled students at no additional cost.',
  ...
  'hire-graduates': {
    ...
    videoSrcMobile: '/videos/employer-hero.mp4',
    ...
    belowHeroSubheadline: 'Connect with Elevate graduates in healthcare, skilled trades, CDL, technology, and more.',
    primaryCta: { label: 'Post a Job', href: '/hire-graduates#post-job' },
    secondaryCta: { label: 'Become a Hiring Partner', href: '/for-employers', variant: 'secondary' },
    trustIndicators: ['Industry-credentialed graduates', 'Background-check ready', 'Workforce-ready'],
    transcript: 'Elevate graduates are credential-ready, pre-screened, and job-ready. Connect with trained talent in healthcare, trades, CDL, and technology.',
    analyticsName: 'hire-graduates',
  },
  ...
  'for-employers': {
    ...
    belowHeroSubheadline: 'Hire trained graduates, sponsor apprentices, or partner with us to train your existing workforce.',
    primaryCta: { label: 'Become a Hiring Partner', href: '/for-employers#partner' },
    secondaryCta: { label: 'Hire Graduates', href: '/hire-graduates', variant: 'secondary' },
    trustIndicators: ['DOL Registered Apprenticeship Sponsor', 'Tax credits available', 'Workforce-ready graduates'],
    transcript: 'Elevate connects employers with trained, credentialed graduates and offers apprenticeship sponsorship, workforce training partnerships, and hiring support.',
    analyticsName: 'for-employers',
  },
  ...
  faq: {
    ...
    belowHeroSubheadline: 'Everything you need to know about programs, funding, enrollment, and credentials.',
    primaryCta: { label: 'Apply Now', href: '/apply' },
    secondaryCta: { label: 'Contact Us', href: '/contact', variant: 'secondary' },
    trustIndicators: ['Free for eligible students', 'WIOA & state funding', 'No hidden fees'],
    transcript: 'Find answers to common questions about Elevate programs, funding eligibility, enrollment, and credentials.',
    analyticsName: 'faq',
  },
  ...
  'financial-aid': {
    ...
    belowHeroSubheadline: 'WIOA, Next Level Jobs, DOL grants, and other funding sources can cover 100% of tuition for qualifying Indiana residents.',
    primaryCta: { label: 'Check Eligibility', href: '/check-eligibility' },
    secondaryCta: { label: 'Apply Now', href: '/apply', variant: 'secondary' },
    trustIndicators: ['WIOA funding', 'Next Level Jobs', 'DOL grants', 'No upfront cost'],
    transcript: 'Most Elevate programs are available at no cost to eligible Indiana residents through WIOA, Next Level Jobs, and DOL funding. Check your eligibility today.',
    analyticsName: 'financial-aid',
  },
  ...
  certifications: {
    ...
    belowHeroSubheadline: 'Industry certifications in healthcare, trades, technology, and business — backed by national credentialing bodies.',
    primaryCta: { label: 'See Programs', href: '/programs' },
    secondaryCta: { label: 'Apply Now', href: '/apply', variant: 'secondary' },
    trustIndicators: ['NHA certified', 'EPA 608 certified', 'CompTIA ready', 'IRS PTIN credential'],
    transcript: 'Elevate programs lead to industry-recognized credentials — NHA, EPA 608, CompTIA, IRS PTIN, and more. Credentials that employers hire for.',
    analyticsName: 'certifications',
  },
  ...
  'apprenticeship-sponsor': {
    ...
    belowHeroSubheadline: 'Elevate is a DOL Registered Apprenticeship Sponsor. Apprentices earn wages while completing structured on-the-job training and related instruction.',
    primaryCta: { label: 'Apply as Apprentice', href: '/apply?program=apprenticeship' },
    secondaryCta: { label: 'Sponsor an Apprentice', href: '/for-employers', variant: 'secondary' },
    trustIndicators: ['DOL Registered', 'Earn while you learn', 'RAPIDS tracked', 'Employer-sponsored'],
    transcript: 'As a DOL Registered Apprenticeship Sponsor, Elevate connects apprentices with employers who pay wages during training. Earn while you learn.',
    analyticsName: 'apprenticeship-sponsor',
  },

  'program-holder': {
    pageKey: 'program-holder',
    videoSrcDesktop: '/videos/partner-join-narrated.mp4',
    posterImage: '/images/pages/program-holder-page-1.jpg',
    videoSrcMobile: '/videos/partner-join-narrated.mp4',
    ...
    belowHeroSubheadline: 'Program holders access our ETPL approval, DOL sponsorship, and student funding infrastructure to deliver workforce training.',
    primaryCta: { label: 'Apply as Program Holder', href: '/apply?type=program-holder' },
    secondaryCta: { label: 'Learn More', href: '/program-holder#how-it-works', variant: 'secondary' },
    trustIndicators: ['ETPL approved', 'DOL Registered Apprenticeship Sponsor', 'Funding infrastructure included'],
    transcript: 'Program holders partner with Elevate to deliver workforce training using our ETPL approval, DOL sponsorship, and student funding infrastructure.',
    analyticsName: 'program-holder',
  },
  ...
  locations: {
    ...
    belowHeroSubheadline: 'In-person, hybrid, and online training options across Indiana — with employer site training available.',
    primaryCta: { label: 'Find a Location', href: '/locations#map' },
    secondaryCta: { label: 'Apply Now', href: '/apply', variant: 'secondary' },
    trustIndicators: ['Indianapolis, Indiana', 'Hybrid & online options', 'Employer site training'],
    transcript: 'Elevate offers training in Indianapolis and across Indiana — in-person, hybrid, and fully online. Find the format that works for you.',
  ...
  start: {
    ...
    belowHeroSubheadline: 'Tell us about yourself and we\'ll match you with the right program and funding pathway.',
    primaryCta: { label: 'Start Now', href: '/apply' },
    secondaryCta: { label: 'See Programs', href: '/programs', variant: 'secondary' },
    trustIndicators: ['Free for eligible students', 'Fast enrollment', 'Funding pre-checked'],
    transcript: 'Start your career training journey at Elevate. Tell us about yourself and we will match you with the right program and funding pathway.',
    analyticsName: 'start',
  },
};
