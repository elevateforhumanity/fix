export const quiz = [
  ...
  {
    question: 'What should a technician include in their professional portfolio?',
    options: [
      'Only their EPA 608 card',
      'Certifications, work samples, references, and a professional resume',
      'Social media profiles',
      'A list of tools they own',
    ],
