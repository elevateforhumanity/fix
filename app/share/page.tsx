    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[300px] md:h-[350px] flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          <Share2 className="w-12 h-12 mx-auto mb-4 text-white/80" />
          <h1 className="text-3xl md:text-5xl font-bold mb-4">Share Elevate</h1>
          <p className="text-lg md:text-xl text-gray-100">
            Help someone access free career training and change their life.
          </p>
        </div>
      </section>
