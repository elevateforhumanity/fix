...
<div className="bg-brand-blue-700 text-white py-12">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <section id="purpose" className="mb-12">
          ...
          <p className="text-gray-700"><strong>Supersonic Fast Cash</strong> operates as a trade name of 2Exclusive LLC-S (d/b/a Elevate for Humanity Career &amp; Technical Institute), registered in Indiana. Tax preparation services are provided by licensed tax preparers with valid PTINs.</p>
        </section>
