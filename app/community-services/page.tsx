        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6 text-left">
            <div className="bg-white/10 rounded-xl p-6">
              ...
              <p className="text-slate-600 text-sm">Income under $64,000/year</p>
            </div>
            <div className="bg-white/10 rounded-xl p-6">
              <h3 className="font-bold text-brand-blue-400 mb-2">WIOA Training</h3>
              <p className="text-slate-600 text-sm">Low-income, unemployed, underemployed, or facing barriers</p>
            </div>
            <div className="bg-white/10 rounded-xl p-6">
              <h3 className="font-bold text-brand-blue-400 mb-2">Mental Wellness</h3>
              <p className="text-slate-600 text-sm">Open to all community members</p>
            </div>
          </div>
          <Link
