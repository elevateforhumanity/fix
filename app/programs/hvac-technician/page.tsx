...
export const metadata: Metadata = {
  ...
  description: 'HVAC technician training in Indianapolis. 15-week program with EPA 608, OSHA 30, and 6 industry credentials. Funding available through WIOA for qualifying adults.',
  ...
  openGraph: {
    ...
    description: '15-week HVAC program with EPA 608, OSHA 30, and 6 industry credentials. Funding available for qualifying adults.',
  ...
  twitter: {
    ...
    title: 'HVAC Technician Training | Elevate for Humanity',
    description: '15-week HVAC program with EPA 608, OSHA 30, and 6 industry credentials in Indianapolis.',
  ...
  return (
    <>
      <ProgramStructuredData program={{
        ...
        description: '15-week HVAC fundamentals program with EPA 608, OSHA 30, 6 industry credentials, employer site days, and apprenticeship readiness. Funding available through WIOA.',
        duration_weeks: 20,
        price: 0,
        image_url: `${SITE_URL}/images/trades/hero-program-hvac.jpg`,
        category: 'Skilled Trades',
        outcomes: ['Residential HVAC Certification 1', 'Residential HVAC Certification 2', 'EPA 608 Universal Certification', 'OSHA 30 Safety Certification', 'CPR/First Aid', 'Rise Up'],
      }} />
      <HVACProgramContent />
    </>
  );
