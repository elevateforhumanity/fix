      ...
      <div className="max-w-lg w-full">
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <Link
              href="/support"
              className="flex-1 inline-flex items-center justify-center gap-2 border border-slate-300 hover:bg-white text-slate-700 px-6 py-3 rounded-lg font-medium transition-colors"
            >
