          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-amber-900 font-medium">
                This program is not a cosmetology school and does not issue state licensure hours. 
                Enrollment requires concurrent or subsequent participation in a licensed cosmetology school for state licensure eligibility.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-slate-100 py-8">
        <div className="mx-auto max-w-4xl px-6">
          <p className="text-sm text-slate-600 text-center">
            <strong>Disclaimer:</strong> This program is not a cosmetology school and does not issue state licensure hours. 
            Enrollment requires concurrent or subsequent participation in a licensed cosmetology school for state licensure eligibility. 
