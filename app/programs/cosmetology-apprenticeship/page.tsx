  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[240px] sm:h-[320px] md:h-[400px]">
        <Image src="/images/beauty/hero-program-cosmetology.jpg" alt="Cosmetology Apprenticeship" fill className="object-cover" priority />
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="flex flex-col sm:flex-row gap-5 items-start">
            <div className="relative w-full h-[200px] sm:w-72 sm:h-[280px] rounded-xl overflow-hidden flex-shrink-0">
              <Image src="/images/beauty/program-beauty-training.jpg" alt="Cosmetology training" fill className="object-cover" />
            </div>
            <div>
