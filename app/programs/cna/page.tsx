          ...
          <div className="max-w-2xl">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/apply?program=cna-certification" className="inline-flex items-center justify-center px-8 py-4 bg-pink-500 hover:bg-pink-400 text-white font-semibold rounded-full transition-all transform hover:scale-105 shadow-lg shadow-pink-500/30">
      ...
      <section className="py-20 bg-pink-600 text-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/apply?program=cna-certification" className="inline-flex items-center justify-center px-8 py-4 bg-white text-pink-600 font-semibold rounded-full hover:bg-pink-50 transition-all transform hover:scale-105 shadow-lg">
