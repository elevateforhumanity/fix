...
export default function BusinessPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <ProgramHeroBanner videoSrc="/videos/partner-business.mp4" voiceoverSrc="/audio/heroes/business.mp3" />
      ...
      <section className="relative h-[240px] sm:h-[320px] md:h-[400px]">
        <Image src="/images/hero/hero-business.jpg" alt="Business & Entrepreneurship Programs" fill sizes="100vw" className="object-cover" priority />
      ...
      <section className="py-8 sm:py-14 bg-brand-blue-600">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-white mb-6 text-sm">Learn tax prep and start your own business. Apply today.</p>
