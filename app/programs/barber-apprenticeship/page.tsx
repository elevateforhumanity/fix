...
export default async function BarberApprenticeshipPage() {
  ...
  return (
    <main className="min-h-screen bg-white text-black">
      ...
      {/* HOW IT WORKS */}
      <section id="how-it-works" className="max-w-7xl mx-auto px-6 py-20 bg-white scroll-mt-20">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-black text-center">How the Program Works</h2>
        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="text-center">
            ...
            <h3 className="font-bold text-black text-lg mb-2">Enroll & Pay</h3>
            <p className="text-blue-100 text-sm">
              Complete application and get matched with a host barbershop.
            </p>
          </div>
          <div className="text-center">
            <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <h3 className="font-bold text-black text-lg mb-2">Start Training</h3>
            <p className="text-blue-100 text-sm">
          ...
          <div className="text-center">
            ...
            <h3 className="font-bold text-black text-lg mb-2">Track Hours</h3>
            <p className="text-blue-100 text-sm">
          ...
          <div className="text-center">
            ...
            <h3 className="font-bold text-black text-lg mb-2">Get Licensed</h3>
            <p className="text-blue-100 text-sm">
