      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        <div className="grid md:grid-cols-3 gap-6 mb-10">
          <div className="rounded-2xl overflow-hidden shadow-sm">
            <Image src="/images/pages/programs-welding-apply-d1.jpg" alt="Welding training" width={400} height={300} className="w-full h-full object-cover" sizes="(max-width: 768px) 100vw, 33vw" />
          ...
          <div className="rounded-2xl overflow-hidden shadow-sm">
            <Image src="/images/pages/programs-welding-apply-d2.jpg" alt="Welding program" width={400} height={300} className="w-full h-full object-cover" sizes="(max-width: 768px) 100vw, 33vw" />
          ...
          <div className="rounded-2xl overflow-hidden shadow-sm">
            <Image src="/images/pages/programs-hero.jpg" alt="Welding career" width={400} height={300} className="w-full h-full object-cover" sizes="(max-width: 768px) 100vw, 33vw" />
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-10">
          <Link href="/inquiry?program=welding" className="block bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow border">
            <Image src="/images/pages/apply-page-1.jpg" alt="Request information about Welding" width={600} height={300} className="w-full h-full object-cover" sizes="(max-width: 768px) 100vw, 50vw" />
          ...
          <Link href="/apply/student?program=welding" className="block bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow border">
            <Image src="/images/pages/apply-hero.jpg" alt="Apply for Welding" width={600} height={300} className="w-full h-full object-cover" sizes="(max-width: 768px) 100vw, 50vw" />
            <div className="p-6 text-center">
