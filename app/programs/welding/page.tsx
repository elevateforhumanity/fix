...
export default function WeldingProgramPage() {
  ...
  return (
    <>
      ...
      <HeroVideo
        videoSrcDesktop={heroBanners['welding'].videoSrcDesktop}
        posterImage={heroBanners['welding'].posterImage}
        voiceoverSrc={heroBanners['welding'].voiceoverSrc}
        microLabel={heroBanners['welding'].microLabel}
        belowHeroHeadline={heroBanners['welding'].belowHeroHeadline}
        belowHeroSubheadline={heroBanners['welding'].belowHeroSubheadline}
        ctas={[heroBanners['welding'].primaryCta, ...(heroBanners['welding'].secondaryCta ? [heroBanners['welding'].secondaryCta] : [])]}
        trustIndicators={heroBanners['welding'].trustIndicators}
        transcript={heroBanners['welding'].transcript}
        analyticsName={heroBanners['welding'].analyticsName}
      />
