...
export const metadata: Metadata = {
  title: 'Plumbing Training | Plumber Certification | Elevate',
  description: 'Plumbing training in Indianapolis. Learn residential and commercial plumbing systems. Funding available for qualifying students.',
  alternates: { canonical: `${SITE_URL}/programs/plumbing` },
  openGraph: {
    title: 'Plumbing Training | Indianapolis',
    description: 'Residential and commercial plumbing training with certification.',
    ...
    <div className="min-h-screen bg-white">
      <div className="bg-slate-50 border-b">
        <div className="max-w-6xl mx-auto px-4 py-3">
          <Breadcrumbs items={[{ label: 'Programs', href: '/programs' }, { label: 'Skilled Trades', href: '/programs/skilled-trades' }, { label: 'Plumbing' }]} />
        </div>
      </div>

      <section className="relative h-[240px] sm:h-[320px] md:h-[400px]">
        <Image src="/images/trades/hero-program-plumbing.jpg" alt="Plumbing Training" fill className="object-cover" priority />
        ...
        <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-10">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-2xl sm:text-4xl font-bold text-white mb-2">Plumbing Training</h1>
            <p className="text-sm sm:text-lg text-white/90 max-w-xl">
              Learn residential and commercial plumbing installation, repair, and code compliance.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-slate-900 py-5">
        <div className="max-w-4xl mx-auto px-4 grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
          {[
            ...
            { val: 'IPC Code', label: 'Certification' },
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="flex flex-col sm:flex-row gap-5 items-start">
            <div className="relative w-full h-[200px] sm:w-72 sm:h-[280px] rounded-xl overflow-hidden flex-shrink-0">
              <Image src="/images/trades/program-plumbing-training.jpg" alt="Plumbing student" fill className="object-cover" />
            </div>
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-3">What You&apos;ll Learn</h2>
              <p className="text-slate-600 text-sm leading-relaxed mb-3">Hands-on training in plumbing installation and repair.</p>
              <div className="space-y-2">
                {['Pipe fitting, soldering, and joining methods', 'Water supply and drainage systems', 'Fixture installation (sinks, toilets, water heaters)', 'Code compliance and permit requirements', 'Leak detection and troubleshooting', 'OSHA safety standards'].map((item) => (
      ...
      <section className="py-8 sm:py-14 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              { title: 'Apprentice Plumber', salary: '$35K-$45K' },
              { title: 'Journeyman Plumber', salary: '$50K-$70K' },
              { title: 'Master Plumber', salary: '$65K-$90K' },
              { title: 'Plumbing Contractor', salary: '$75K-$120K+' },
            ].map((c) => (
      ...
      <section className="py-8 sm:py-14 bg-orange-500">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-xl sm:text-2xl font-bold text-white mb-3">Start Your Plumbing Career</h2>
          <p className="text-white/90 mb-6 text-sm">High demand, strong pay. Apply today.</p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/apply?program=plumbing" className="bg-white text-orange-600 font-bold px-6 py-3 rounded-lg text-base hover:bg-orange-50 transition-colors text-center">
