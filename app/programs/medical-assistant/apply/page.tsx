      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        <div className="grid md:grid-cols-3 gap-6 mb-10">
          <div className="rounded-2xl overflow-hidden shadow-sm">
            <Image src="/images/pages/programs-medical-apply-hero.jpg" alt="Medical Assistant training" width={400} height={300} className="w-full h-48 object-cover" />
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-10">
          <Link href="/inquiry?program=medical-assistant" className="block bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow border">
            <Image src="/images/pages/programs-medical-apply-hero.jpg" alt="Request information about Medical Assistant" width={600} height={300} className="w-full h-52 object-cover" />
          ...
          <Link href="/apply/student?program=medical-assistant" className="block bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow border">
            <Image src="/images/pages/programs-medical-apply-hero.jpg" alt="Apply for Medical Assistant" width={600} height={300} className="w-full h-52 object-cover" />
            <div className="p-6 text-center">
