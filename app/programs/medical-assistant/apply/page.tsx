  ...
  return (
    <main className="min-h-screen bg-white">
      <div className="relative h-[40vh] min-h-[300px] max-h-[400px]">
        <Image src="/images/heroes/programs/healthcare/hero-program-medical-assistant.jpg" alt="Medical Assistant" fill sizes="100vw" className="object-cover" priority quality={90} />
      </div>
