...
export const metadata: Metadata = {
  title: 'Apply for HVAC Technician | Elevate for Humanity',
  description: 'Apply for our HVAC Technician program. Free training with WIOA funding available.',
};
    ...
    <main className="min-h-screen bg-white">
      <div className="bg-blue-900 text-white py-8">
        <div className="max-w-4xl mx-auto px-6">
          ...
          />
          <h1 className="text-3xl md:text-4xl font-bold">Apply for HVAC Technician</h1>
