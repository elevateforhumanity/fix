  ...
  return (
    <main className="min-h-screen bg-white">
      <div className="relative h-[40vh] min-h-[300px] max-h-[400px] overflow-hidden">
        <Image src="/images/pages/programs-electrical-apply-hero.jpg" alt="Electrical" fill sizes="100vw" className="object-cover" priority />
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        <div className="grid md:grid-cols-3 gap-6 mb-10">
          <div className="rounded-2xl overflow-hidden shadow-sm">
            <Image src="/images/pages/programs-electrical-apply-d2.jpg" alt="Electrical training" width={400} height={300} className="w-full h-48 object-cover"  sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw" />
          ...
          <div className="rounded-2xl overflow-hidden shadow-sm">
            <Image src="/images/pages/programs-electrical-apply-d3.jpg" alt="Electrical program" width={400} height={300} className="w-full h-48 object-cover"  sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw" />
          ...
          <div className="rounded-2xl overflow-hidden shadow-sm">
            <Image src="/images/pages/programs-electrical-apply-d1.jpg" alt="Electrical career" width={400} height={300} className="w-full h-48 object-cover"  sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw" />
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-10">
          <Link href="/inquiry?program=electrical" className="block bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow border">
            <Image src="/images/pages/electrical.jpg" alt="Request information about Electrical" width={600} height={300} className="w-full h-52 object-cover"  sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw" />
          ...
          <Link href="/apply/student?program=electrical" className="block bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow border">
            <Image src="/images/pages/programs-page-hero.jpg" alt="Apply for Electrical" width={600} height={300} className="w-full h-52 object-cover"  sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw" />
            <div className="p-6 text-center">
