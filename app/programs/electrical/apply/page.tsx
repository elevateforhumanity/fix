      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        <div className="grid md:grid-cols-3 gap-6 mb-10">
          <div className="rounded-2xl overflow-hidden shadow-sm">
            <Image src="/images/pages/programs-electrical-apply-d2.jpg" alt="Electrical training" width={400} height={300} className="w-full h-48 object-cover" />
          ...
          <div className="rounded-2xl overflow-hidden shadow-sm">
            <Image src="/images/pages/programs-electrical-apply-d3.jpg" alt="Electrical program" width={400} height={300} className="w-full h-48 object-cover" />
          ...
          <div className="rounded-2xl overflow-hidden shadow-sm">
            <Image src="/images/pages/programs-electrical-apply-d1.jpg" alt="Electrical career" width={400} height={300} className="w-full h-48 object-cover" />
