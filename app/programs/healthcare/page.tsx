  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[240px] sm:h-[320px] md:h-[400px]">
        <Image src="/images/hero/hero-healthcare.jpg" alt="Healthcare Training Programs" fill sizes="100vw" className="object-cover" priority quality={90} />
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="flex flex-col sm:flex-row gap-5 items-start">
            <div className="relative w-full h-[200px] sm:w-72 sm:h-[280px] rounded-xl overflow-hidden flex-shrink-0">
              <Image src="/images/healthcare/hero-programs-healthcare.jpg" alt="Healthcare training" fill sizes="100vw" quality={90} className="object-cover" />
            </div>
            <div>
