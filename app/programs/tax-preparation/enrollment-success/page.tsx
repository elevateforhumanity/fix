    ...
    <div className="min-h-screen bg-gradient-to-b from-brand-green-50 to-white">
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="bg-white rounded-xl shadow-sm border p-8 mb-8">
          ...
          <ol className="space-y-6">
            <li className="flex gap-4">
              <span className="flex-shrink-0 w-8 h-8 bg-brand-green-600 text-white rounded-full flex items-center justify-center font-bold text-sm">
                1
              </span>
              <div>
        ...
        <p className="text-center text-sm text-gray-500 mt-8">
          Questions? Call{' '}
          <a href="tel:317-314-3757" className="text-brand-green-600 hover:underline">
            317-314-3757
          </a>{' '}
          or email{' '}
          <a
