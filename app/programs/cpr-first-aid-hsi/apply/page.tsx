  ...
  return (
    <main className="min-h-screen bg-white">
      <div className="relative h-[40vh] min-h-[300px] max-h-[400px]">
        <Image src="/images/healthcare/cpr-group-training-session.jpg" alt="CPR & First Aid (HSI)" fill className="object-cover" priority />
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        <div className="grid md:grid-cols-3 gap-6 mb-10">
          <div className="rounded-2xl overflow-hidden shadow-sm">
            <Image src="/images/healthcare/cpr-individual-practice.jpg" alt="CPR & First Aid (HSI) training" width={400} height={300} className="w-full h-48 object-cover" />
          ...
          <div className="rounded-2xl overflow-hidden shadow-sm">
            <Image src="/images/healthcare/cpr-certification-group.jpg" alt="CPR & First Aid (HSI) program" width={400} height={300} className="w-full h-48 object-cover" />
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-10">
          <Link href="/inquiry?program=cpr-first-aid-hsi" className="block bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow border">
            <Image src="/images/healthcare/cpr-individual-practice.jpg" alt="Request information about CPR & First Aid (HSI)" width={600} height={300} className="w-full h-52 object-cover" />
          ...
          <Link href="/apply/student?program=cpr-first-aid-hsi" className="block bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow border">
            <Image src="/images/healthcare/cpr-group-training-session.jpg" alt="Apply for CPR & First Aid (HSI)" width={600} height={300} className="w-full h-52 object-cover" />
            <div className="p-6 text-center">
