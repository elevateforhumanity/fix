...
export default function NailTechnicianPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <ProgramHeroBanner videoSrc="/videos/nail-tech.mp4" voiceoverSrc="/audio/heroes/nail-tech.mp3" />
      ...
      <section className="py-8 sm:py-14 bg-brand-red-600">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-white mb-6 text-sm">Creative career with flexible schedule. Apply today.</p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/apply?program=nail-technician-apprenticeship" className="bg-white text-brand-red-600 font-bold px-6 py-3 rounded-lg text-base hover:bg-brand-red-50 transition-colors text-center">
