...
export const metadata: Metadata = {
  title: 'Enrollment Confirmed | Nail Technician Apprenticeship',
  robots: 'noindex',
};

export default function NailTechApplySuccessPage() {
  return (
      ...
      <div className="max-w-lg w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-black text-lg">
            Your enrollment in the Nail Technician Apprenticeship program is confirmed.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden mb-6">
          ...
          <div className="p-6">
            ...
            <Link
              href="/signup?role=apprentice&redirect=/programs/nail-technician-apprenticeship/enrollment-success"
            ...
            <p className="text-center text-xs text-black mt-3">
              ...
              <Link href="/login?redirect=/programs/nail-technician-apprenticeship/enrollment-success" className="text-brand-blue-600 hover:underline">
                Sign in
              </Link>
            </p>
          </div>
