  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[240px] sm:h-[320px] md:h-[400px]">
        <Image src="/images/hero/hero-certifications.jpg" alt="Micro Programs — Short-Term Certifications" fill sizes="100vw" className="object-cover" priority quality={90} />
