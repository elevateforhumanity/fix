      ...
      <section className="py-12 bg-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/wioa-eligibility" className="bg-white border-2 border-purple-600 text-purple-600 px-10 py-5 rounded-lg font-semibold text-xl hover:bg-purple-50 transition-colors">
              Check Eligibility
            </Link>
          </div>
        </div>
