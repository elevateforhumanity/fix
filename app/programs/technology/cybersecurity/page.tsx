  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[240px] sm:h-[320px] md:h-[400px]">
        <Image src="/images/technology/cybersecurity-hero.jpg" alt="Cybersecurity Training" fill className="object-cover" priority />
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="flex flex-col sm:flex-row gap-5 items-start">
            <div className="relative w-full h-[200px] sm:w-72 sm:h-[280px] rounded-xl overflow-hidden flex-shrink-0">
              <Image src="/images/technology/hero-program-cybersecurity.jpg" alt="Cybersecurity lab" fill className="object-cover" />
            </div>
            <div>
      ...
      <section className="py-8 sm:py-14 bg-blue-600">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/apply?program=cybersecurity" className="bg-white text-blue-600 font-bold px-6 py-3 rounded-lg text-base hover:bg-blue-50 transition-colors text-center">
