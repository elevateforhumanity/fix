    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-8 sm:py-14 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            {[
              { name: 'Building Technician with HVAC Fundamentals', href: '/programs/hvac-technician', img: '/images/trades/hero-program-hvac.jpg', duration: '8-16 weeks' },
              ...
              { name: 'Forklift Certification', href: '/programs/forklift', img: '/images/trades/hero-program-carpentry.jpg', duration: '1 day' },
            ].map((p) => (
      ...
      <section className="py-8 sm:py-14 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            {[
              { title: 'Building Technician', salary: '$42K-$70K' },
      ...
      <section className="py-8 sm:py-14 bg-brand-orange-500">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-white mb-6 text-sm">High demand, strong pay. Apply today.</p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/apply?program=skilled-trades" className="bg-white text-brand-orange-600 font-bold px-6 py-3 rounded-lg text-base hover:bg-brand-orange-50 transition-colors text-center">
