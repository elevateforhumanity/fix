          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              ...
              <ul className="space-y-3">
                {['18 years or older', 'High school diploma or GED', 'Reliable transportation', 'Ability to lift 50+ lbs'].map((req) => (
      ...
      <section className="py-16 lg:py-24 bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-400 max-w-2xl mx-auto">Skilled trades offer strong wages, job security, and career growth.</p>
          </div>
      ...
      <section className="py-16 bg-orange-500">
        <div className="max-w-3xl mx-auto px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link href="/apply?program=skilled-trades" className="inline-block bg-white text-orange-600 px-8 py-4 font-semibold rounded-full hover:bg-orange-50 transition-colors">
              Apply Now
            </Link>
