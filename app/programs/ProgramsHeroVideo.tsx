...
export default function ProgramsHeroVideo() {
  ...
  return (
    <>
      <video ref={videoRef} className="absolute inset-0 w-full h-full object-cover brightness-110" loop muted playsInline autoPlay preload="metadata" poster="/images/pages/training-cohort.jpg">
