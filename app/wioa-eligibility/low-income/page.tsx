    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h2 className="text-3xl font-bold text-black mb-6">Low-Income Individual Eligibility</h2>
          ...
          <div className="prose max-w-none">
            ...
            <h3 className="text-2xl font-bold text-black mb-4">Income Guidelines (2024)</h3>
            <div className="bg-green-50 p-6 rounded-lg mb-6">
              <table className="w-full text-left">
                <thead>
                  <tr className="border-b-2 border-green-200">
                    <th className="py-2 font-bold text-black">Family Size</th>
                    <th className="py-2 font-bold text-black">Annual Income Limit</th>
                  </tr>
                </thead>
              ...
              <p className="text-sm text-black mt-4">*Guidelines updated annually. Some programs use 70% of Lower Living Standard Income Level (LLSIL).</p>
            </div>
            ...
            <h3 className="text-2xl font-bold text-black mb-4">How to Apply</h3>
            <ol className="list-decimal pl-6 space-y-2 text-black mb-6">
        ...
        <div className="bg-green-50 border-2 border-green-600 p-8 rounded-lg mb-8">
          ...
          <p className="text-black mb-6">Visit Indiana Career Connect to check your eligibility and apply for WIOA funding.</p>
          
          <div className="bg-white p-6 rounded-lg mb-6">
            <h4 className="font-bold text-black mb-4">Application Instructions:</h4>
          ...
          <p className="text-sm text-black">Official Indiana state workforce system</p>
        </div>
        ...
        <div className="bg-gray-900 text-white p-8 rounded-lg text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact" className="px-8 py-4 bg-white text-black font-bold rounded-lg hover:bg-gray-100 transition">
              Get Application Help
            </Link>
            <Link href="tel:317-314-3757" className="px-8 py-4 border-2 border-white text-white font-bold rounded-lg hover:bg-white hover:text-black transition">
              Call: 317-314-3757
            </Link>
          </div>
        </div>
