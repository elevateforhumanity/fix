        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="bg-white rounded-lg p-6 border-2 border-blue-200 text-center">
              <Image src="/images/icons/trending-up.png" alt="Job Placement" width={48} height={48} className="mx-auto mb-3" />
            ...
            <div className="bg-white rounded-lg p-6 border-2 border-green-200 text-center">
              <Image src="/images/icons/users.png" alt="Students" width={48} height={48} className="mx-auto mb-3" />
            ...
            <div className="bg-white rounded-lg p-6 border-2 border-purple-200 text-center">
              <Image src="/images/icons/check-circle.png" alt="Programs" width={48} height={48} className="mx-auto mb-3" />
            ...
            <div className="bg-white rounded-lg p-6 border-2 border-orange-200 text-center">
              <Image src="/images/icons/clock.png" alt="Since 2020" width={48} height={48} className="mx-auto mb-3" />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg p-8 border-2 border-gray-200">
              <Image src="/images/icons/book.png" alt="Training Coordination" width={64} height={64} className="mb-4" />
            ...
            <div className="bg-white rounded-lg p-8 border-2 border-gray-200">
              <Image src="/images/icons/dollar.png" alt="Funding Access" width={64} height={64} className="mb-4" />
            ...
            <div className="bg-white rounded-lg p-8 border-2 border-gray-200">
              <Image src="/images/icons/trending-up.png" alt="Career Support" width={64} height={64} className="mb-4" />
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg p-8 border-2 border-green-200">
              <div className="flex items-center gap-3 mb-4">
                <Image src="/images/icons/check-circle.png" alt="What We Are" width={48} height={48} />
