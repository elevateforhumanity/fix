        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {[
              ...
              {
                title: 'Veterans',
                image: '/images/pages/about-partner-cta.jpg',
              ...
              },
              {
                ...
                image: '/images/pages/about-team-hero.jpg',
      ...
      <section className="py-12 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { name: 'CNA Certification', duration: '4–6 weeks', image: '/images/pages/cna-nursing.jpg', href: '/programs/cna' },
              { name: 'CDL Training', duration: '4–6 weeks', image: '/images/pages/cdl-training.jpg', href: '/programs/cdl-training' },
              { name: 'Building Technician with HVAC Fundamentals', duration: '12–16 weeks', image: '/images/pages/hvac-technician.jpg', href: '/programs/hvac-technician' },
              { name: 'Electrical', duration: '12–16 weeks', image: '/images/pages/electrical.jpg', href: '/programs/electrical' },
              { name: 'Barber Apprenticeship', duration: '~18 months', image: '/images/pages/barber-hero-main.jpg', href: '/programs/barber-apprenticeship' },
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            ...
            <Link href="/about/partners" className="bg-slate-50 rounded-xl overflow-hidden border border-gray-200 hover:shadow-md transition">
              <div className="relative h-40 overflow-hidden">
                <Image src="/images/pages/about-partners-hero.jpg" alt="Employer and community partners" fill sizes="(max-width: 640px) 100vw, 33vw" quality={90} className="object-cover" />
              </div>
              <div className="p-5">
