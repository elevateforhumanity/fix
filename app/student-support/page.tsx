        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-6 text-center">
              ...
              <p className="text-sm text-slate-700 mt-1">Mon–Fri 8am–6pm EST</p>
              <Link
            ...
            <div className="bg-white rounded-xl p-6 text-center">
              ...
              <p className="text-sm text-slate-700 mt-1">Average response: under 2 minutes</p>
              <Link
                href="/support/chat"
                className="inline-flex items-center gap-2 mt-4 bg-brand-green-600 text-white px-5 py-2.5 rounded-lg text-sm font-semibold hover:bg-brand-green-700 transition"
              >
            ...
            <div className="bg-white rounded-xl p-6 text-center">
              ...
              <p className="text-slate-700">Book a one-on-one</p>
              <p className="text-sm text-slate-700 mt-1">In-person or virtual available</p>
              <Link
