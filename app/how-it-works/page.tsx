      ...
      <section className="relative min-h-[500px] md:min-h-[600px] flex items-center">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/apply"
              className="inline-block px-8 py-4 bg-red-600 text-white rounded-lg font-bold hover:bg-red-700 transition-colors"
            >
              Apply Now
            </Link>
            <a
              href="tel:+13173143757"
              className="inline-block px-8 py-4 bg-white text-blue-900 rounded-lg font-bold hover:bg-gray-100 transition-colors"
            >
              Call (317) 314-3757
            </a>
          </div>
