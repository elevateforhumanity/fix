...
export default async function EmployeesPage() {
  ...
  const { data: employees, count } = await db.from('employees').select('*', { count: 'exact' }).order('created_at', { ascending: false });
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-[160px] sm:h-[220px] md:h-[280px]">
        <Image src="/images/pages/admin-hr-employees-hero.jpg" alt="HR administration" fill sizes="100vw" className="object-cover" priority />
      </section>
