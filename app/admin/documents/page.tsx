...
export default async function DocumentsPage() {
  ...
  const { data: documents, count } = await db.from('documents').select('*', { count: 'exact' }).order('created_at', { ascending: false }).limit(20);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-[160px] sm:h-[220px] md:h-[280px]">
        <Image src="/images/pages/admin-documents-hero.jpg" alt="Administration" fill sizes="100vw" className="object-cover" priority />
      </section>
