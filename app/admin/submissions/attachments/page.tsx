...
export default async function AttachmentLibraryPage() {
  ...
  if (!user) redirect('/login?redirect=/admin/submissions/attachments');
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="/admin/submissions/attachments/upload" className="inline-flex items-center gap-2 px-4 py-2 bg-brand-blue-600 text-white rounded-lg text-sm font-semibold hover:bg-brand-blue-700 transition">
