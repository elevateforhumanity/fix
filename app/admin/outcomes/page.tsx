  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-[160px] sm:h-[220px] md:h-[280px]">
        <Image src="/images/pages/admin-outcomes-hero.jpg" alt="Administration" fill sizes="100vw" className="object-cover" priority />
      </section>
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-sm border p-6"><h3 className="text-sm font-medium text-gray-500">Employment Rate</h3><p className="text-3xl font-bold text-brand-green-600 mt-2">78%</p></div>
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6"><h3 className="text-sm font-medium text-gray-500">Retention (6mo)</h3><p className="text-3xl font-bold text-brand-orange-600 mt-2">82%</p></div>
        </div>
