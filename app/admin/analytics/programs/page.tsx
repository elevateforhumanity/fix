      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <nav className="text-sm mb-4">
            <ol className="flex items-center space-x-2 text-slate-700">
              ...
              <li>/</li>
              <li className="text-slate-900 font-medium">Programs</li>
            </ol>
          </nav>
          <h1 className="text-3xl font-bold text-slate-900">Program Analytics</h1>
          <p className="text-slate-700 mt-2">Track program performance and participant outcomes</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-sm border p-6">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-medium text-slate-700">Total Programs</h3>
            ...
            <p className="text-3xl font-bold text-slate-900 mt-2">{totalPrograms || 0}</p>
            <p className="text-sm text-slate-700 mt-1">All programs</p>
          </div>

          <div className="bg-white rounded-lg shadow-sm border p-6">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-medium text-slate-700">Active Programs</h3>
            ...
            <p className="text-3xl font-bold text-slate-900 mt-2">{activePrograms || 0}</p>
            <p className="text-sm text-slate-700 mt-1">Currently running</p>
          </div>

          <div className="bg-white rounded-lg shadow-sm border p-6">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-medium text-slate-700">Participants</h3>
              <span className="text-brand-blue-600 bg-brand-blue-100 p-2 rounded-lg">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-3xl font-bold text-slate-900 mt-2">{totalParticipants || 0}</p>
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <p className="text-sm text-slate-700 mt-1">Program completion</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border">
          <div className="p-6 border-b">
            ...
            <p className="text-sm text-slate-700">Latest program activity</p>
          </div>
