  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-[280px] md:h-[350px] lg:h-[400px] flex items-center justify-center text-white overflow-hidden">
        <Image
          src="/images/certifications/cpr.jpg"
          alt="Deletions"
          fill
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-base md:text-lg mb-8 text-gray-100">
            Manage user data deletion requests in compliance with GDPR and CCPA
            regulations.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-base md:text-lg text-brand-blue-100 mb-8">
              Process FERPA and privacy-related data deletion requests.
                        </p>
