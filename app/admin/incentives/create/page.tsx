  ...
  return (
    <div className="min-h-screen bg-white p-6">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="text-2xl font-bold text-slate-900 mb-6">Create Incentive</h1>
        ...
        <form action={createIncentive} className="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
          ...
          <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-100">
            <Link href="/admin/incentives" className="px-4 py-2 text-sm text-slate-700 hover:text-slate-900">Cancel</Link>
