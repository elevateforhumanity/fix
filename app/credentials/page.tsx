...
const industryCerts = [
  ...
  { name: 'Phlebotomy Technician (CPT)', issuer: 'Authorized Testing Center', field: 'Healthcare', desc: 'National certification for blood draw and specimen collection. Exam administered on-site at Elevate — authorized testing center.', img: '/images/pages/phlebotomy.jpg' },
  { name: 'Medical Assistant (CCMA)', issuer: 'Authorized Testing Center', field: 'Healthcare', desc: 'Clinical and administrative medical assisting. Exam administered on-site at Elevate — authorized testing center.', img: '/images/pages/medical-assistant.jpg' },
