...
const credentials = [
  ...
  { name: 'EPA Section 608 Universal Certification', field: 'HVAC', issuer: 'EPA (via ESCO Institute & Mainstream Engineering)', desc: 'Required by federal law to purchase and handle refrigerants. 15-week prep curriculum with study kits, practice test bank, and proctored certification exam administered through EPA-approved certifying organizations. Exam fees and retesting policies vary by provider. Certification does not expire.' },
