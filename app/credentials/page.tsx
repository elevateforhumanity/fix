...
const industryCerts = [
  ...
  { name: 'EPA Section 608', issuer: 'EPA (via Mainstream Engineering)', field: 'HVAC', desc: 'Required by federal law to handle refrigerants. Proctored on-site by our EPA 608 Certified Proctor using the Mainstream Engineering QwikTest system. Does not expire.' },
