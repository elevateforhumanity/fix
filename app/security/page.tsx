            ...
            {securityMeasures.map((measure, index) => {
              ...
              return (
                <div key={index} className="bg-white rounded-lg shadow-sm p-6">
                  ...
                  <p className="text-slate-700">{measure.description}</p>
                </div>
              );
            })}
          </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {certifications.map((cert: any) => (
                <div key={cert.id} className="bg-white rounded-lg shadow-sm p-6 border-2 border-gray-100">
                  ...
                  {cert.description && (
                    <p className="text-sm text-slate-700 mb-2">{cert.description}</p>
                  )}
                  {cert.valid_until && (
        ...
        <section>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-sm text-slate-700">How we collect and use data</p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-slate-700">Platform usage terms</p>
            </Link>
            <Link
              href="/cookies"
              className="bg-white rounded-lg shadow-sm p-4 hover:shadow-md transition"
            >
              ...
              <p className="text-sm text-slate-700">How we use cookies</p>
            </Link>
          </div>
        </section>
