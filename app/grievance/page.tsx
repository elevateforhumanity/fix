    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-brand-blue-700 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <Scale className="w-10 h-10 mx-auto mb-4 text-slate-700" />
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl font-bold text-slate-900 mb-8">Grievance Process</h2>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl font-bold text-slate-900 mb-6">Grounds for Filing</h2>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              ...
              <p className="text-slate-700 text-sm mb-2">Send your written grievance to:</p>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              ...
              <p className="text-slate-700 text-sm mb-2">Call to discuss your concern or request a grievance form:</p>
      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-xl font-bold text-slate-900 mb-4">External Agencies</h2>
      ...
      <section className="py-8">
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-white border border-gray-200 rounded-xl p-6 text-sm text-slate-700">
