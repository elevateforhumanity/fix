...
const featuredCategories = [
  { slug: 'healthcare', name: 'Healthcare', image: '/images/pages/programs-page-hero.jpg', courses: 5, description: 'CNA, Medical Assistant, Phlebotomy, CPR & First Aid, and Pharmacy Technician training.' },
  { slug: 'skilled-trades', name: 'Skilled Trades', image: '/images/pages/programs-page-hero.jpg', courses: 6, description: 'HVAC, Electrical, Welding, Plumbing, and Construction certifications.' },
  { slug: 'technology', name: 'Technology', image: '/images/pages/programs-page-hero.jpg', courses: 4, description: 'Cybersecurity, IT Help Desk, Software Development, and Networking.' },
  { slug: 'cdl', name: 'CDL & Transportation', image: '/images/pages/programs-page-hero.jpg', courses: 3, description: 'Class A and Class B CDL training with job placement assistance.' },
  { slug: 'barber-apprenticeship', name: 'Beauty & Barbering', image: '/images/pages/programs-page-hero.jpg', courses: 3, description: 'Barber apprenticeships, cosmetology, and nail technician programs.' },
  { slug: 'business', name: 'Business & Finance', image: '/images/pages/programs-page-hero.jpg', courses: 4, description: 'Bookkeeping, Office Administration, Tax Preparation, and Entrepreneurship.' },
];
              ...
              {featuredCourses.map((course) => (
                ...
                >
                  <div className="relative h-40 overflow-hidden">
                    <Image
                      src={course.image_url || '/images/pages/programs-page-hero.jpg'}
                      alt={course.title}
                      fill
