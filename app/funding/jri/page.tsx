    ...
    <div className="min-h-screen bg-white">      <div className="bg-white border-b">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-start">
            <div>
              ...
              <Link href="/start" className="inline-flex items-center gap-2 bg-brand-green-600 hover:bg-brand-green-700 text-white px-8 py-4 rounded-full font-bold transition hover:scale-105 shadow-lg">
                Apply for Job Ready Indy Funding <ArrowRight className="w-5 h-5" />
              </Link>
            </div>
            <div className="relative h-[300px] rounded-2xl overflow-hidden shadow-xl">
              <Image src="/images/pages/funding-page-4.jpg" alt="Job Ready Indy career training" fill className="object-cover" sizes="(max-width: 768px) 100vw, 50vw" />
            </div>
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="bg-white rounded-xl p-6 border border-slate-200">
                <p className="text-slate-700 leading-relaxed">
                  Job Ready Indy funding covers tuition and training fees, certification and exam fees, required tools, uniforms, and supplies, and background check fees where applicable. There is no cost to the participant for any covered program.
                </p>
              </div>
            </div>
            <div>
      ...
      <section className="py-14 sm:py-20">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 text-center mb-10">How to Get Job Ready Indy Funding</h2>
          <div className="space-y-6">
            {[
              ...
              { step: '3', title: 'Get Approved', desc: 'WorkOne confirms your Job Ready Indy eligibility and issues a funding voucher for your training program.' },
              { step: '4', title: 'Start Training', desc: 'Begin your program. For approved participants, Job Ready Indy covers tuition and related costs.' },
            ].map((s) => (
