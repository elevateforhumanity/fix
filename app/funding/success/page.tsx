      ...
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-6">
          ...
          <div className="text-left space-y-4">
            <div className="flex items-start gap-3">
              <div className="flex-shrink-0 w-8 h-8 bg-brand-red-600 text-white rounded-full flex items-center justify-center font-bold text-sm">
                •
              </div>
              <div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link
            ...
            className="px-6 py-3 bg-white text-brand-blue-600 border-2 border-brand-blue-600 rounded-lg hover:bg-white font-bold transition-all"
          >
            Back to Dashboard
          </Link>
        </div>
