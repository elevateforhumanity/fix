...
export const metadata: Metadata = {
  ...
  description: 'Explore funding options for career training including WIOA, JRI, and state programs. Most adults qualify for Funded training.',
  alternates: {
    canonical: 'https://www.elevateforhumanity.org/funding',
  },
  openGraph: {
    title: 'Funding Options for Free Career Training',
    description: 'WIOA, JRI, and state funding programs. Most adults qualify for Funded training.',
