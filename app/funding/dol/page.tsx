...
const programs = (dbRows as any[]) || [];
  ...
  return (
    <div className="min-h-screen bg-white">      <div className="bg-white border-b">
      ...
      {/* How to Enroll */}
      <section className="py-14 sm:py-20 bg-brand-blue-700 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="grid sm:grid-cols-3 gap-8">
            {[
              ...
              <div key={s.step}>
                <div className="w-12 h-12 rounded-full bg-brand-blue-700 text-white text-xl font-bold flex items-center justify-center mx-auto mb-4">{s.step}</div>
