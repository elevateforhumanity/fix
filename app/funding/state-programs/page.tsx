    ...
    <div className="min-h-screen bg-white">      <div className="max-w-7xl mx-auto px-4 py-4">
      ...
      <section className="relative w-full">
        ...
        <div className="bg-white py-10">
          <div className="max-w-5xl mx-auto px-4 text-center">
            <h1 className="text-3xl md:text-4xl font-bold text-slate-900 mb-3">State Funding Programs</h1>
            <p className="text-lg text-black max-w-3xl mx-auto">Indiana workforce development grants and training funds for residents and employers.</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-4 space-y-8">
          {PROGRAMS.map((p) => (
            <div key={p.name} className="bg-white border border-slate-200 rounded-xl p-6 md:p-8">
              ...
              <p className="text-sm text-black mb-4">Administered by: {p.admin}</p>
      ...
      <section className="py-16 bg-slate-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-white mb-8 text-lg">Our enrollment team will help match you with the right state funding program.</p>
