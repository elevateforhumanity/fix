    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full">
        <div className="relative h-[300px] md:h-[400px] w-full overflow-hidden">
          <Image src="/images/homepage/funders-philanthropy.jpg" alt="How funding works for career training" fill className="object-cover" priority quality={90} sizes="100vw" />
        </div>
