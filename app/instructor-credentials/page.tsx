...
export default function InstructorCredentialsPage() {
  return (
    <div className="bg-white min-h-screen">
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-3 gap-4 mb-10">
            <div className="bg-white rounded-lg p-4 text-center">
              ...
              <p className="text-xs text-slate-700 mt-1">State-approved or licensed instructional authorities</p>
            </div>
            <div className="bg-white rounded-lg p-4 text-center">
              ...
              <p className="text-xs text-slate-700 mt-1">Authorized RTI coordinators under licensed supervision</p>
            </div>
            <div className="bg-white rounded-lg p-4 text-center">
              ...
              <p className="text-xs text-slate-700 mt-1">Supplemental instruction and mentoring</p>
            </div>
          </div>
      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl font-bold text-slate-900 mb-2">Program-Specific Instructor Requirements</h2>
              ...
              <div key={i} className="bg-white rounded-xl border overflow-hidden">
                ...
                <div className="p-6 space-y-5">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-700 mt-1">Regulatory body: {prog.regulatoryBody}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-1">
                      {prog.instructorRequirements.map((req, j) => (
                        <li key={j} className="text-sm text-slate-900 flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-900">{prog.programHolderRole}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-900">{prog.smeScope}</p>
                  </div>
            ...
            {[
              ...
              <div key={i} className="border rounded-lg p-5">
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-2">
                  ...
                  <span className="text-xs text-slate-700 sm:ml-auto">{item.parties}</span>
                </div>
