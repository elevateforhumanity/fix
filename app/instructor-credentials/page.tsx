...
const PROGRAM_CREDENTIALS = [
  ...
  },
  {
    ...
    credentialPartner: 'Authorized CompTIA Academy',
    instructorRequirements: [
    ...
    smeScope: 'CompTIA-certified IT professionals provide supplemental tutoring, lab mentoring, and exam preparation support.',
    credentialIssued: 'CompTIA A+ — issued by CompTIA',
    regulatoryBody: 'CompTIA',
  },
  {
    ...
    credentialIssued: 'CompTIA Security+ — issued by CompTIA',
    regulatoryBody: 'CompTIA',
  },
  {
    program: 'Welding',
