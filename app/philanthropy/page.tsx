  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[300px] sm:h-[380px] overflow-hidden">
        <Image src="/images/heroes-hq/success-hero.jpg" alt="Support workforce training" fill className="object-cover" priority sizes="100vw" />
        <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/25 to-transparent" />
        <div className="absolute inset-0 flex items-end">
          <div className="max-w-6xl mx-auto px-4 w-full pb-10 sm:pb-14">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-2">Support Our Mission</h1>
            <p className="text-lg text-white/90 max-w-2xl">Help us create pathways out of poverty through workforce training, certifications, and career services.</p>
          </div>
        </div>
      </section>
