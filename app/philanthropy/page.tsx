    ...
    <div className="min-h-screen bg-white">      <div className="bg-white border-b">
      ...
      <section className="py-16 sm:py-24 border-t">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <Link href="/contact" className="inline-flex items-center gap-2 bg-brand-red-600 text-white px-10 py-4 rounded-lg font-bold text-lg hover:bg-brand-red-700 transition shadow-sm">
