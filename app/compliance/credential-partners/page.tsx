...
const CREDENTIAL_PARTNERS = [
  {
    ...
    licensingBody: 'Authorized Certification Testing Center',
    ...
    credentialIssuer: 'Authorized Testing Center',
    ...
    notes: 'Program is not currently on the WorkOne/ETPL funded list. Self-pay with BNPL options. CPT exam fee $129. Exam administered on-site through Elevate — authorized testing center.',
  },
  {
    ...
    notes: 'CCMA exam fee $165. Exam administered on-site through Elevate — authorized testing center.',
  },
  {
