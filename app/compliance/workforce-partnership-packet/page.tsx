  ...
  return (
    <div className="bg-white min-h-screen print:bg-white">
      ...
      <div className="hidden print:block px-8 pt-8 pb-4 border-b-2 border-gray-900">
        ...
        <p className="text-sm text-slate-700">Elevate for Humanity — Partnership Documentation</p>
        <p className="text-xs text-slate-700 mt-1">RAPIDS ID: 2025-IN-132301 | INTraining Location ID: 10004621</p>
      </div>
          ...
          <div className="grid sm:grid-cols-2 gap-6 mb-8">
            <div>
              <dl className="space-y-3 text-sm">
                <div>
                  <dt className="font-semibold text-slate-700 text-xs uppercase tracking-wider">Organization</dt>
                  <dd className="text-slate-900 font-medium">Elevate for Humanity Career &amp; Technical Institute</dd>
                </div>
                <div>
                  <dt className="font-semibold text-slate-700 text-xs uppercase tracking-wider">Legal Entity</dt>
                  <dd className="text-slate-900">2Exclusive LLC-S (DBA Elevate for Humanity Career &amp; Technical Institute)</dd>
                </div>
                <div>
                  <dt className="font-semibold text-slate-700 text-xs uppercase tracking-wider">Classification</dt>
                  <dd className="text-slate-900">Hybrid Workforce Training Provider & Registered Apprenticeship Sponsor</dd>
                </div>
                <div>
                  <dt className="font-semibold text-slate-700 text-xs uppercase tracking-wider">Location</dt>
            ...
            <div>
              <dl className="space-y-3 text-sm">
                <div>
                  <dt className="font-semibold text-slate-700 text-xs uppercase tracking-wider">RAPIDS Registration</dt>
                  <dd className="text-slate-900">2025-IN-132301</dd>
                </div>
                <div>
                  <dt className="font-semibold text-slate-700 text-xs uppercase tracking-wider">INTraining Location</dt>
                  <dd className="text-slate-900">10004621</dd>
                </div>
                <div>
                  <dt className="font-semibold text-slate-700 text-xs uppercase tracking-wider">Approvals</dt>
                  <dd className="text-slate-900">WIOA Eligible Training Provider, WRG Provider, Indiana DWD Listed</dd>
                </div>
                <div>
                  <dt className="font-semibold text-slate-700 text-xs uppercase tracking-wider">Cohort Setup Time</dt>
                  <dd className="text-slate-900 font-medium">~2 weeks from agreement to enrollment</dd>
                </div>
              </dl>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 border print:bg-white print:border-gray-300">
            ...
            <div className="grid sm:grid-cols-2 gap-3 text-sm">
              <div className="flex items-start gap-2">
                ...
                <span className="text-slate-900">RTI via licensed credential partners (mapped hours)</span>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-brand-green-600 flex-shrink-0 mt-0.5" />
                <span className="text-slate-900">OJT via approved employer partners</span>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-brand-green-600 flex-shrink-0 mt-0.5" />
                <span className="text-slate-900">Competency-based assessment with mapped standards</span>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-brand-green-600 flex-shrink-0 mt-0.5" />
                <span className="text-slate-900">LMS tracking for RTI hours, modules, and evaluations</span>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-brand-green-600 flex-shrink-0 mt-0.5" />
                <span className="text-slate-900">Credentials issued by licensed authorities (not Elevate)</span>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-brand-green-600 flex-shrink-0 mt-0.5" />
                <span className="text-slate-900">MOU-governed partner relationships</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <table className="w-full text-xs border-collapse print:text-[10px]">
              <thead>
                <tr className="bg-white print:bg-white">
                  ...
                  <th className="text-center p-2.5 font-semibold text-slate-900 border-b">RTI Hrs</th>
                  <th className="text-center p-2.5 font-semibold text-slate-900 border-b">OJT Hrs</th>
                  <th className="text-left p-2.5 font-semibold text-slate-900 border-b">Credential</th>
              ...
              <tbody>
                {PROGRAMS.map((p, i) => (
                  <tr key={i} className={i % 2 === 0 ? 'bg-white/50' : 'bg-white'}>
                    ...
                    <td className="p-2.5 text-slate-900 border-b">{p.duration}</td>
                    <td className="p-2.5 text-slate-900 border-b">{p.format}</td>
                    <td className="p-2.5 text-center text-brand-blue-700 font-semibold border-b print:text-slate-900">{p.rtiHours}</td>
                    <td className="p-2.5 text-center text-slate-900 border-b">{p.ojtHours.toLocaleString()}</td>
                    <td className="p-2.5 text-slate-900 border-b">{p.credential}</td>
                    <td className="p-2.5 text-slate-700 border-b">{p.funding}</td>
                  </tr>
                ))}
              </tbody>
            </table>
            ...
            {[
              ...
              return (
                <div key={i} className="bg-white rounded-lg p-4 border print:bg-white print:border-gray-300">
                  <Icon className="w-5 h-5 text-brand-blue-600 mb-2 print:text-slate-900" />
            ...
            {[
              ...
              <div key={i} className="flex gap-4 items-start bg-white rounded-lg p-4 border print:border-gray-300">
                ...
                <div>
                  ...
                  <p className="text-slate-700 text-xs mt-0.5">{step.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-10">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl font-bold text-slate-900 mb-2">Assessment & Competency Verification</h2>
          <p className="text-slate-700 text-sm mb-6">
          ...
          <div className="bg-white rounded-lg p-6 border print:bg-white print:border-gray-300">
            <div className="space-y-4 text-sm">
              <div>
                ...
                <ul className="space-y-1 text-slate-900 text-xs">
          ...
          <div className="bg-white rounded-lg border p-6 print:border-gray-300">
            <div className="grid sm:grid-cols-2 gap-4 text-sm">
              <div className="flex items-start gap-3">
                <Mail className="w-5 h-5 text-brand-blue-600 flex-shrink-0 print:text-slate-900" />
                <div>
                  <p className="font-semibold text-slate-900">Email</p>
                  <p className="text-slate-900">info@elevateforhumanity.org</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <Phone className="w-5 h-5 text-brand-blue-600 flex-shrink-0 print:text-slate-900" />
                <div>
                  <p className="font-semibold text-slate-900">Phone</p>
                  <p className="text-slate-900">(317) 794-0484</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-brand-blue-600 flex-shrink-0 print:text-slate-900" />
                <div>
                  <p className="font-semibold text-slate-900">Location</p>
                  <p className="text-slate-900">Indianapolis, Indiana</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <Shield className="w-5 h-5 text-brand-blue-600 flex-shrink-0 print:text-slate-900" />
                <div>
                  <p className="font-semibold text-slate-900">Website</p>
                  <p className="text-slate-900">www.elevateforhumanity.org</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-10 print:hidden">
        <div className="max-w-4xl mx-auto px-4">
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/workone-partner-packet" className="inline-flex items-center gap-2 px-4 py-2 border border-gray-300 text-slate-900 rounded-lg text-sm font-medium hover:bg-white transition">
