...
export const COURSES: Course[] = [
  ...
  // HVAC & Trades — EPA 608
  {
    ...
    description: 'Proctored EPA Section 608 certification exam administered through an approved testing partner. Includes all four sections (Core, Type I, Type II, Type III) for Universal certification. Online exam with unlimited retesting included. Certification does not expire and is recognized nationwide.',
    provider: 'EPATest.com (Approved Testing Partner)',
    ...
    features: [
      ...
      'Unlimited retesting at no additional cost',
  ...
  },
  {
    ...
    description: 'Complete EPA Section 608 Universal certification pathway. 15-week structured prep course covering Core, Type I, Type II, and Type III sections. Study kit provided at no cost. Practice exams included. Proctored certification exam access with unlimited online retesting.',
    provider: 'Elevate for Humanity / EPATest.com',
    category: 'HVAC & Trades',
    price: 199,
    wholesaleCost: 45,
    duration: '15 weeks',
  ...
  },
  {
    ...
    description: 'Everything you need to go from zero to EPA 608 Universal certified. Includes the 15-week certification prep course, study kit, practice exams, and proctored exam with unlimited retesting. Designed for students in the Elevate HVAC Technician program or anyone preparing for EPA 608 certification independently.',
    provider: 'Elevate for Humanity / EPATest.com',
    category: 'HVAC & Trades',
    price: 249,
    wholesaleCost: 55,
