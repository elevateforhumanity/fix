...
export const COURSES: Course[] = [
  ...
  // HVAC & Trades — EPA 608
  {
    ...
    description: 'Proctored EPA Section 608 certification exam administered through EPA-approved certifying organizations (ESCO Institute and Mainstream Engineering). Includes all four sections (Core, Type I, Type II, Type III) for Universal certification. Exam fees and retesting policies vary by certifying organization. Certification does not expire and is recognized nationwide.',
  ...
  },
  {
    ...
    shortDescription: '15-week certification prep course with proctored exam access',
    description: 'Complete EPA Section 608 Universal certification pathway. 15-week structured prep course covering Core, Type I, Type II, and Type III sections. Study kit provided at no cost. Practice exams included. Proctored certification exam access through EPA-approved certifying organizations. Exam fees and retesting policies vary by provider.',
    ...
    features: [
      '15-week structured certification prep curriculum',
  ...
  },
  {
    ...
    description: 'Everything you need to go from zero to EPA 608 Universal certified. Includes the 15-week certification prep course, study kit, practice exams, and proctored exam through EPA-approved certifying organizations. Exam fees and retesting policies vary by provider. Designed for students in the Elevate HVAC Technician program or anyone preparing for EPA 608 certification independently.',
    provider: 'Elevate for Humanity Career & Technical Institute',
    category: 'HVAC & Trades',
    price: 249,
    wholesaleCost: 55,
    ...
    features: [
      'Complete 15-week EPA 608 prep curriculum',
