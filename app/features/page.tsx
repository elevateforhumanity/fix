...
<<<<<<< HEAD
      <p className="mt-4 text-gray-600">Platform features for learners, employers, and workforce partners.</p>
...
=======
      <p className="mt-4 text-slate-700">Platform features for learners, employers, and workforce partners.</p>
      <div className="mt-8 flex gap-4">
        <a href={siteConfig.handoff.apply} className="rounded bg-black px-5 py-3 text-white hover:bg-gray-800">Apply Now</a>
