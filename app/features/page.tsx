  ...
  return (
    <div className="min-h-screen bg-white">      <div className="bg-white border-b">
      ...
      <section className="relative h-[50vh] sm:h-[55vh] md:h-[60vh] lg:h-[65vh] min-h-[320px] overflow-hidden">
        <Image src="/images/pages/features-hero.jpg" alt="Platform features" fill className="object-cover" priority sizes="100vw" />
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div className="relative h-[300px] rounded-2xl overflow-hidden shadow-xl">
              <Image src="/images/pages/features-page-1.jpg" alt="Self-service platform" fill className="object-cover" sizes="(max-width: 768px) 100vw, 50vw" />
            </div>
            <div>
