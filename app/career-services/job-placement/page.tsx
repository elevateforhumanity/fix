    ...
    <div className="min-h-screen bg-white">      {/* Breadcrumbs */}
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-white border-2 border-gray-200 rounded-2xl overflow-hidden hover:border-brand-orange-600 transition">
            <div className="relative h-40 overflow-hidden">
              <Image src="/images/pages/career-services-page-4.jpg" alt="Job matching" fill className="object-cover" sizes="(max-width: 768px) 100vw, 33vw" />
            </div>
            <div className="p-8">
          ...
          <div className="bg-white border-2 border-gray-200 rounded-2xl overflow-hidden hover:border-brand-orange-600 transition">
            <div className="relative h-40 overflow-hidden">
              <Image src="/images/pages/career-services-page-5.jpg" alt="Interview preparation" fill className="object-cover" sizes="(max-width: 768px) 100vw, 33vw" />
            </div>
            <div className="p-8">
