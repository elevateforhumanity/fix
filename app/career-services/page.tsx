    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="space-y-4 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-5">
            {[
              ...
              { title: 'Direct Employer Connections', desc: 'We match you with employers in your field who are actively hiring. Many of our graduates receive job offers before they finish training.', image: '/images/homepage/employer-partnership.png' },
            ].map((item) => (
      ...
      <section className="py-8 sm:py-14 bg-blue-600">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-white/90 mb-6 text-sm">Apply for training and career services are included at no extra cost.</p>
