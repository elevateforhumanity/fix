...
const POLICIES: PolicyItem[] = [
  {
    ...
    details: [
      'I understand my role and responsibilities as a host salon',
      'I understand the compensation requirements for apprentices',
      'I understand the hour tracking and verification procedures',
      'I understand the competency development expectations across all service categories',
  ...
  },
  {
    ...
    summary: 'I certify that my salon meets all health and safety requirements.',
    details: [
      'My salon maintains a valid Indiana salon license',
      'All tools, stations, and implements are properly sanitized and disinfected',
      ...
      'All chemical services are performed with proper ventilation and PPE',
    ],
  },
  {
    id: 'confidentiality',
  ...
  },
  {
    ...
    details: [
      ...
      'I will report any changes to salon ownership, licensing, insurance, or supervising cosmetologist within 5 business days',
    ],
  },
];

export default function CosmetologyPolicyAcknowledgmentPage() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-6 border-b">
        <div className="max-w-4xl mx-auto px-4">
          <Link href="/partners/cosmetology-apprenticeship/forms" className="inline-flex items-center gap-1 text-black hover:text-purple-700 text-sm mb-4">
            <ArrowLeft className="w-4 h-4" /> Back to Forms
          </Link>
          <InstitutionalHeader
            documentType="Policy Acknowledgment"
            title="Host Salon Policy Review"
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <button
                      type="button"
                      onClick={() => togglePolicy(policy.id)}
                      className={`mt-3 text-sm font-medium ${isAcked ? 'text-brand-green-600' : 'text-purple-600 hover:text-purple-700'}`}
                    >
