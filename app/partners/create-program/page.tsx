...
import { CheckCircle2, FileText, Users, Award, BarChart3 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[300px] md:h-[350px] flex items-center justify-center text-white overflow-hidden">
        <Image src="/images/heroes-hq/employer-hero.jpg" alt="Create a training program" fill className="object-cover" priority sizes="100vw" />
