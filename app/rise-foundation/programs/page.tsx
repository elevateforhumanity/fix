...
import { ChevronRight, GraduationCap, Users, Calendar, ArrowRight, CheckCircle, Loader2 } from 'lucide-react';
...
export default function RiseFoundationProgramsPage() {
  ...
  useEffect(() => {
    async function fetchPrograms() {
      try {
        const res = await fetch('/api/rise-foundation/programs');
        if (res.ok) {
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        {programs.length === 0 ? (
          <div className="text-center py-12 bg-white rounded-xl border">
            ...
            <p className="text-gray-600">No programs available at this time. Check back soon!</p>
          </div>
        ) : (
