...
const certPrograms = [
  ...
  { name: 'CDL — Commercial Driver License', duration: '4-8 weeks', cost: 'Free with WRG', image: '/images/programs-hq/cdl-trucking.jpg', href: '/programs/cdl' },
  ...
  { name: 'CPR/AED/First Aid (HSI)', duration: '1 day', cost: '$65-$85', image: '/images/programs-hq/cna-training.jpg', href: '/programs/cpr-first-aid-hsi' },
  { name: 'OSHA 10 / OSHA 30', duration: '2-4 days', cost: 'Included with trades programs', image: '/images/trades/program-welding-training.jpg', href: '/programs/skilled-trades' },
  { name: 'Welding Certification', duration: '8-12 weeks', cost: 'Free with WIOA', image: '/images/trades/program-construction-training.jpg', href: '/programs/skilled-trades' },
];
      ...
      <section className="relative h-[300px] sm:h-[380px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-end">
          <div className="max-w-6xl mx-auto px-4 w-full pb-10 sm:pb-14">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-2">Certification Training</h1>
            <p className="text-lg text-white/90 max-w-2xl">Get certified in weeks, not years. Many programs are free for eligible Indiana residents.</p>
          </div>
        </div>
      </section>
