...
<div className="bg-white border-b">
      ...
      <section className="relative h-48 md:h-64 overflow-hidden">
        <Image src="/images/pages/mentorship-page-12.jpg" alt="Career Guidance" fill className="object-cover" priority sizes="100vw" />
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <Link href="/start" className="bg-brand-orange-500 hover:bg-brand-orange-600 text-white px-8 py-4 rounded-lg text-lg font-bold transition inline-flex items-center">
