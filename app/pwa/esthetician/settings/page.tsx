...
export default function EstheticianSettingsPage() {
    ...
    <div className="min-h-screen bg-slate-900 pb-20">
      ...
      <main className="px-4 py-6 space-y-4">
        <div className="bg-slate-800 rounded-xl overflow-hidden">
          <Link href="/pwa/esthetician/profile" className="flex items-center justify-between p-4 hover:bg-slate-700 transition">
