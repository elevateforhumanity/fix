...
const policies = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Job Ready Indy Policy', href: '/policies/jri', icon: Scale, description: 'Job Ready Indy program policy' },
...
{/* Intro Section */}
      ...
      <div className="bg-brand-blue-50 rounded-xl p-6 text-center">
        <p className="text-gray-700">
          ...
          <a href="/contact" className="text-brand-orange-600 hover:underline font-medium">
            our contact form
          </a>
        </p>
      {/* CTA Section */}
