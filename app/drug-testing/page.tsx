...
{/* Hero */}
      ...
      <section className="relative w-full">
        <div className="relative h-[300px] md:h-[400px] w-full overflow-hidden">
          <Image src="/images/healthcare/hero-programs-healthcare.jpg" alt="Professional Drug Testing Services" fill className="object-cover" priority quality={90} sizes="100vw" />
        </div>
