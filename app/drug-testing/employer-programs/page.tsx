...
{/* Hero */}
      ...
      <section className="relative w-full">
        <div className="relative h-[300px] md:h-[400px] w-full overflow-hidden">
          <Image src="/images/courses/medical-assistant-10002419-cover.jpg" alt="Employer Drug Testing Programs" fill className="object-cover" priority quality={90} sizes="100vw" />
        </div>
