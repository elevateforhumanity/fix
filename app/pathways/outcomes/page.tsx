...
const PROGRAMS = [
  ...
  },
  {
    ...
    credential: 'EPA Section 608 Certification + OSHA 10-Hour Safety Certification',
    issuedBy: 'U.S. Environmental Protection Agency (EPA) + Occupational Safety and Health Administration (OSHA)',
    whatItMeans: 'EPA 608 certification is required by federal law to handle refrigerants — you cannot legally work on air conditioning or refrigeration systems without it. OSHA 10 is a workplace safety credential required by most construction and maintenance employers. Together, these credentials make you immediately employable as an HVAC technician.',
    ...
    examDay: 'You take the EPA 608 exam (Universal certification covering all refrigerant types) and the OSHA 10-hour safety exam. Both are administered during the program.',
    whoHires: [
  ...
  },
  {
    ...
    credential: 'CompTIA A+ (Core 1 + Core 2)',
    issuedBy: 'CompTIA (Computing Technology Industry Association)',
    whatItMeans: 'CompTIA A+ is the entry-level IT certification recognized by employers worldwide. It proves you can troubleshoot hardware and software, configure networks, and support end users. It is vendor-neutral — meaning it applies to any technology environment, not just one brand. Many employers list CompTIA A+ as a minimum requirement for IT support roles.',
    training: 'You learn hardware and software troubleshooting, network configuration and administration, operating systems (Windows, Linux, macOS), cloud computing basics (AWS, Azure), and cybersecurity fundamentals. The program is online-friendly with live virtual instructor sessions. Self-paced modules plus scheduled group sessions. Includes CompTIA A+ exam prep and practice tests.',
    duration: '8–12 weeks',
    examDay: 'You take the CompTIA A+ exam in two parts: Core 1 (hardware, networking, mobile devices) and Core 2 (operating systems, security, troubleshooting). Exam prep and practice tests are included in the program.',
    whoHires: [
    ...
    funding: 'If you qualify for WIOA or JRI funding, the program is covered for eligible participants. Remote work is available in many IT support roles — you do not have to relocate.',
    nextStep: 'CompTIA A+ leads to Network+ (networking), then Security+ (cybersecurity). This is a defined career ladder: help desk → systems administrator → network engineer → cybersecurity analyst. Each step increases your salary.',
  },
  {
    name: 'Cybersecurity',
    ...
    issuedBy: 'CompTIA (Computing Technology Industry Association)',
    whatItMeans: 'CompTIA Security+ is the baseline cybersecurity certification required by the U.S. Department of Defense and recognized by employers worldwide. It proves you understand network security, threat analysis, vulnerability assessment, and incident response. Many government and enterprise security jobs require Security+ as a minimum.',
    training: 'You learn network security, threat analysis, vulnerability assessment, incident response, cryptography, and compliance frameworks (NIST, ISO 27001). Online-friendly with live virtual instructor sessions. Includes Security+ exam prep and practice tests. CompTIA A+ or equivalent experience is recommended but not required.',
    duration: '12–16 weeks',
    examDay: 'You take the CompTIA Security+ exam — a single proctored test covering threats, architecture, implementation, operations, and governance. Exam prep and practice tests are included.',
    whoHires: [
      { employer: 'Security analyst', pay: '$55K–$80K' },
      { employer: 'SOC analyst', pay: '$50K–$75K' },
      { employer: 'Penetration tester', pay: '$70K–$100K' },
      { employer: 'Security engineer', pay: '$80K–$120K' },
    ],
    funding: 'If you qualify for WIOA or JRI funding, the program is covered for eligible participants. Remote work is standard in cybersecurity — most roles can be done from anywhere.',
    nextStep: 'Security+ leads to CySA+ (Cybersecurity Analyst), CASP+ (Advanced Security Practitioner), and CISSP. Penetration testers and security architects earn $100K+.',
  },
];
