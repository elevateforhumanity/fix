  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[160px] sm:h-[220px] md:h-[280px] overflow-hidden">
        <Image src="/images/pages/store-guides-licensing-hero.jpg" alt="Elevate store" fill sizes="100vw" className="object-cover" priority />
      </section>
...
{/* Header */}
      ...
      <section className="py-12 px-4">
        <div className="max-w-4xl mx-auto prose prose-slate prose-lg">
          ...
          <div className="mb-12">
            <h2 className="text-2xl font-bold text-slate-900 flex items-center gap-3">
              <span className="w-8 h-8 bg-amber-600 text-slate-900 rounded-full flex items-center justify-center text-sm font-bold">7</span>
              Billing & Enforcement
            </h2>
