...
{/* Avatar Guide */}
      ...
      <section className="relative w-full">
        <div className="relative h-[300px] md:h-[400px] w-full overflow-hidden">
          <Image src="/images/technology/hero-programs-technology.jpg" alt="WCAG" fill className="object-cover" priority quality={90} sizes="100vw" />
        </div>
      ...
      <section className="py-16 bg-brand-blue-700 text-white">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-brand-blue-100 mb-8">Schedule a demo to see our accessibility tools in action.</p>
