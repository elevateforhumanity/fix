  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-[300px] w-full overflow-hidden">
        <Image src="/images/efh/hero/hero-main-clean.jpg" alt="Apply for Career" width={800} height={600} className="absolute inset-0 w-full h-full object-cover" quality={85} / loading="lazy">
          ...
          <div className="bg-white rounded-lg shadow-sm border p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex gap-4">
                <button
                  type="submit"
                  className="flex-1 bg-orange-600 hover:bg-orange-700 text-white px-8 py-3 rounded-lg font-semibold transition-colors"
                >
                  Submit Application
                </button>
                <Link
