...
const bullets = [
  ...
  'Remote filing available — upload your documents and file from anywhere in Illinois',
  'Same-day refund advance up to $7,500 — zero interest, zero fees',
  'Illinois has a flat 4.95% state income tax rate — we handle both your federal and state returns',
];
...
const services = [
  ...
  { label: 'State Return — Illinois IL-1040', desc: 'Illinois individual income tax return filed alongside your federal.' },
  { label: 'Amended Returns', desc: 'Corrections to prior-year federal or Illinois state returns.' },
  ...
  return (
    <>
      <SupersonicPageHero
        ...
        alt="Tax preparation services in Illinois"
        title="Tax Preparation in Illinois"
      ...
      <main className="max-w-5xl mx-auto px-4 py-14 space-y-16">
        ...
        <section className="bg-slate-50 border border-slate-200 rounded-2xl p-8">
          <h2 className="text-2xl font-bold text-slate-900 mb-3">Cities We Serve in Illinois</h2>
        ...
        {/* Why choose us */}
        <section>
          <h2 className="text-2xl font-bold text-slate-900 mb-6">Why Choose Supersonic Fast Cash in Illinois</h2>
        ...
        {/* Services */}
        <section>
          <h2 className="text-2xl font-bold text-slate-900 mb-8 text-center">Services Available in Illinois</h2>
        ...
        <section className="bg-brand-blue-900 rounded-2xl p-10 text-center">
          <h2 className="text-2xl font-black text-white mb-3">Ready to File in Illinois?</h2>
