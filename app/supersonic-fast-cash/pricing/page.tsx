...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://elevateforhumanity.institute/supersonic-fast-cash/pricing',
  },
};
      ...
      <section className="py-20">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-green-500">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-3">
                  <span className="text-green-600 font-bold text-xl">✓</span>
                  <span className="text-gray-700">Subject to bank approval</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-blue-500">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">Up to $7,500 available</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 font-bold text-xl">✓</span>
                  <span className="text-gray-700">All terms disclosed before funding</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-600 font-bold text-xl">✓</span>
                  <span className="text-gray-700">Cost depends on refund amount and time outstanding</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-amber-50 border-2 border-amber-300 rounded-xl p-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-6">Important Disclosures</h3>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center bg-gray-200 hover:bg-gray-300 text-gray-900 px-8 py-4 rounded-lg font-bold text-lg transition-colors"
            >
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">File Your Return</h3>
              <p className="text-gray-600">
