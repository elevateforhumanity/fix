...
const cities = [
  ...
  'Murfreesboro', 'Franklin', 'Jackson', 'Johnson City', 'Hendersonville',
];

const bullets = [
  'PTIN-certified preparers — your return is signed by a credentialed professional',
  'Remote filing available — upload your documents and file from anywhere in Tennessee',
  'Same-day refund advance up to $7,500 — zero interest, zero fees',
  'Tennessee has no state income tax on wages — federal filing only for most residents',
];
...
const services = [
  ...
  { label: 'Federal Return Only', desc: 'Tennessee residents typically file federal only — no state income tax on wages.' },
...
export default function TaxPreparationTennesseePage() {
  return (
    <>
      <SupersonicPageHero
        image="/images/pages/supersonic-fast-cash-page-1.jpg"
        alt="Tax preparation services in Tennessee"
        title="Tax Preparation in Tennessee"
      ...
      <main className="max-w-5xl mx-auto px-4 py-14 space-y-16">
        ...
        <section className="bg-slate-50 border border-slate-200 rounded-2xl p-8">
          <h2 className="text-2xl font-bold text-slate-900 mb-3">Cities We Serve in Tennessee</h2>
        ...
        {/* Why choose us */}
        <section>
          <h2 className="text-2xl font-bold text-slate-900 mb-6">Why Choose Supersonic Fast Cash in Tennessee</h2>
        ...
        {/* Services */}
        <section>
          <h2 className="text-2xl font-bold text-slate-900 mb-8 text-center">Services Available in Tennessee</h2>
        ...
        <section className="bg-brand-blue-900 rounded-2xl p-10 text-center">
          <h2 className="text-2xl font-black text-white mb-3">Ready to File in Tennessee?</h2>
