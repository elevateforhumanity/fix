      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
          <div>
            ...
            <p className="text-text-secondary mt-1">Track your classes, assignments, and important dates</p>
          </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
              ...
              <div className="grid grid-cols-7 border-b border-slate-200">
                {dayNames.map(day => (
                  <div key={day} className="p-3 text-center text-sm font-semibold text-text-secondary bg-slate-50">
                    {day}
                  </div>
                ))}
              </div>
                      ...
                      {day && (
                        <>
                          ...
                          <div className="mt-1 space-y-1">
                            ...
                            {dayEvents.length > 2 && (
                              <div className="text-xs text-text-secondary px-2">+{dayEvents.length - 2} more</div>
                            )}
                          </div>
                        </>
                      )}
                ...
                <div className="space-y-3">
                  {upcomingAssignments.map((assignment, i) => (
                    <Link key={i} href={`/lms/assignments/${assignment.id}`} className="block p-3 bg-slate-50 rounded-lg hover:bg-slate-100 transition">
                      ...
                      <div className="text-sm text-text-secondary">{assignment.courses?.title}</div>
