    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-text-secondary">Connect with {alumniCount || 0} graduates</p>
        </div>
        {isAlumni && (
          <Link
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div className="bg-white rounded-xl shadow-sm border p-5 text-center">
          ...
          <div className="text-text-secondary text-sm">Total Alumni</div>
        </div>
        <div className="bg-white rounded-xl shadow-sm border p-5 text-center">
          <Briefcase className="w-8 h-8 text-blue-600 mx-auto mb-2" />
          <div className="text-2xl font-bold">85%</div>
          <div className="text-text-secondary text-sm">Employed</div>
        </div>
        <div className="bg-white rounded-xl shadow-sm border p-5 text-center">
            ...
            {stories && stories.length > 0 ? (
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <p className="text-sm text-text-secondary">HVAC Graduate, 2025</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <p className="text-sm text-text-secondary">Medical Assistant Graduate, 2025</p>
                </div>
              </div>
            )}
          </div>
