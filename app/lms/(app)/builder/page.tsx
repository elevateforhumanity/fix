...
export const metadata: Metadata = {
  alternates: {
    canonical: 'https://elevateforhumanity.institute/lms/builder',
  },
  title: 'Builder | Elevate For Humanity',
  description:
    'Explore Builder and discover opportunities for career growth and development.',
};
      ...
      <section className="relative h-[400px] md:h-[500px] lg:h-[600px] flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-base md:text-lg mb-8 text-gray-100">
            Explore Builder and discover opportunities for career growth and
            development.
          </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              <div>
                ...
                <p className="text-black mb-6">
                  Explore Builder and discover opportunities for career growth
                  and development.
                </p>
