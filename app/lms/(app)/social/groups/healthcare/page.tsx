...
export default async function HealthcareGroupPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Banner */}
      <div className="bg-gradient-to-r from-brand-red-500 to-pink-600 text-white">
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-brand-red-100 mt-2 max-w-xl">
            ...
            <div className="flex gap-3">
              ...
              <button className="px-4 py-2 bg-white text-brand-red-600 rounded-lg hover:bg-brand-red-50 font-medium">
                Joined
              </button>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border">
              ...
              <div className="divide-y">
                {recentDiscussions.map((post) => (
                  <div key={post.id} className="p-4 hover:bg-white">
                    <div className="flex gap-4">
                      <div className="w-10 h-10 bg-brand-red-100 rounded-full flex items-center justify-center flex-shrink-0">
                      ...
                      <div className="flex-1">
                        ...
                        <h3 className="font-semibold text-gray-900 mt-1 hover:text-brand-red-600 cursor-pointer">
                          {post.title}
                        </h3>
                        <p className="text-gray-600 text-sm mt-1">{post.preview}</p>
                        <div className="flex items-center gap-4 mt-3">
                          <button className="flex items-center gap-1 text-gray-500 hover:text-brand-red-600 text-sm">
                          ...
                          <button className="flex items-center gap-1 text-gray-500 hover:text-brand-red-600 text-sm ml-auto">
              ...
              <div className="p-4 border-t text-center">
                <button className="text-brand-red-600 hover:text-brand-red-700 font-medium text-sm">
          ...
          <div className="space-y-6">
                ...
                {groupResources.map((resource, i) => (
                  <button key={i} className="w-full flex items-center gap-3 p-3 rounded-lg hover:bg-white text-left">
                    <div className="w-10 h-10 bg-brand-red-100 rounded-lg flex items-center justify-center">
                      <resource.icon className="w-5 h-5 text-brand-red-600" />
                    </div>
                    <div>
            ...
            <div className="bg-white rounded-xl shadow-sm border p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <Link href="/lms/social/groups/healthcare" className="text-brand-red-600 hover:text-brand-red-700 text-sm">See All</Link>
              </div>
              ...
              <button className="w-full mt-4 px-4 py-2 border border-brand-red-600 text-brand-red-600 rounded-lg hover:bg-brand-red-50 text-sm font-medium flex items-center justify-center gap-2">
            ...
            {/* Related Groups */}
            <div className="bg-brand-red-50 rounded-xl p-6">
