            ...
            <div className="bg-white rounded-xl shadow-sm border p-6">
              ...
              <div className="space-y-3">
                <Link href="/programs/skilled-trades" className="flex items-center gap-3 p-3 rounded-lg bg-slate-50 hover:bg-slate-100 transition-colors">
                  ...
                  <div><div className="font-medium text-gray-900 text-sm">Apprenticeship Guide</div><div className="text-xs text-gray-500">How to start your trade career</div></div>
                </Link>
                <Link href="/lms/dashboard" className="flex items-center gap-3 p-3 rounded-lg bg-slate-50 hover:bg-slate-100 transition-colors">
                  <BookOpen className="w-5 h-5 text-brand-blue-600 flex-shrink-0" />
                  <div><div className="font-medium text-gray-900 text-sm">Tool Reviews</div><div className="text-xs text-gray-500">Community-recommended tools</div></div>
                </Link>
                <Link href="/employer" className="flex items-center gap-3 p-3 rounded-lg bg-slate-50 hover:bg-slate-100 transition-colors">
                  <BookOpen className="w-5 h-5 text-brand-blue-600 flex-shrink-0" />
                  <div><div className="font-medium text-gray-900 text-sm">Job Board</div><div className="text-xs text-gray-500">Local trade job listings</div></div>
                </Link>
              </div>
            </div>
