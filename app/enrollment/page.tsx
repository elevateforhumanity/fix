...
export default async function EnrollmentPage() {
  ...
  const featured = [
    { name: 'HVAC Technician', hours: '400+', weeks: '12', credentials: '6', href: '/apply/student?program=hvac-technician', image: '/images/pages/hvac-technician.jpg' },
    ...
    <div className="min-h-screen bg-white">      {/* Hero */}
      ...
      <section className="py-12">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-white text-sm mb-6">Applications are reviewed within 1-2 business days. No application fee.</p>
