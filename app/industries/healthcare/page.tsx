  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative h-[450px] md:h-[500px] w-full overflow-hidden">
        <Image src="/images/efh/hero/hero-main-clean.jpg" alt="Healthcare Programs" width={800} height={600} className="absolute inset-0 w-full h-full object-cover" quality={85} />
