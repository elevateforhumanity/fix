  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[400px] w-full overflow-hidden">
        <Image src="/images/efh/hero/hero-main-clean.jpg" alt="Free Tax Preparation" width={800} height={600} className="absolute inset-0 w-full h-full object-cover" quality={85} loading="lazy" />
