...
export const metadata: Metadata = {
  alternates: { canonical: 'https://www.elevateforhumanity.org/social/share' },
    ...
    <div className="min-h-screen bg-white">
            ...
            {SHARE_OPTIONS.map((opt) => {
              ...
              return (
                <div key={opt.title} className="bg-white border border-gray-200 rounded-xl p-6 flex flex-col">
                  ...
                  <p className="text-slate-700 text-sm mb-6 flex-1">{opt.desc}</p>
                  <Link
                    href={opt.href}
      ...
      <section className="py-12">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-slate-700 mb-6">Copy this link and share it anywhere — social media, text message, or email.</p>
          <div className="bg-white border border-gray-200 rounded-lg p-4 flex items-center gap-3 max-w-lg mx-auto">
            <span className="text-slate-900 text-sm flex-1 truncate">https://www.elevateforhumanity.org/programs</span>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-4">Your Referral Matters</h2>
