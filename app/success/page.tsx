    ...
    <div className="min-h-screen">
      ...
      <section className="relative w-full -mt-[72px]">
        <div className="relative min-h-[70vh] w-full overflow-hidden">
          <Image src="/images/efh/hero/hero-main-clean.jpg" alt="Success Stories" width={800} height={600} className="absolute inset-0 h-full w-full object-cover" quality={85} />
