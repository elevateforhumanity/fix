              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-slate-200">
                    ...
                    <th className="text-center p-4 font-bold text-slate-900 bg-blue-50 border-x border-blue-100">
                      <span className="text-blue-600">Elevate Platform</span>
                    </th>
                ...
                <tbody className="divide-y divide-slate-100">
                  {[
                    ...
                    <tr key={i}>
                      ...
                      <td className="p-4 text-center bg-blue-50/50 border-x border-blue-50">
              ...
              return (
                <div
                  ...
                  className={`rounded-2xl p-8 flex flex-col ${
                    tier.featured
                      ? 'bg-slate-900 text-white ring-2 ring-blue-500 shadow-xl'
                      : 'bg-white border border-slate-200'
                  }`}
                >
                  <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-5 ${
                    tier.featured ? 'bg-blue-500' : 'bg-slate-100'
                  }`}>
                  ...
                  <p className={`text-sm font-medium mb-4 ${tier.featured ? 'text-blue-300' : 'text-slate-500'}`}>
                    {tier.subtitle}
                  </p>
                  ...
                  <ul className="space-y-2 mb-6 flex-1">
                    {tier.features.map((f, j) => (
                      <li key={j} className="flex items-center gap-2">
                        <CheckCircle className={`w-4 h-4 flex-shrink-0 ${tier.featured ? 'text-blue-400' : 'text-emerald-500'}`} />
