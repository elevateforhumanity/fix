# InVideo Reel Script #2: "Barber Apprenticeship – One of the Few in the State"

**Video File**: `reel-barber-apprenticeship.mp4`  
**Format**: 9:16 (Vertical/TikTok/Reels)  
**Duration**: 25–30 seconds  
**Theme**: High-energy, shop vibes, fades, clippers, people laughing, real barbershop feel
...
- Include mentor-apprentice interactions
...
- [ ] Apprentice and mentor working together
- [ ] Client reactions (smiling, checking mirror)
- [ ] Line of waiting clients
- [ ] Barber tools and products
- [ ] Certificate or license
- [ ] Fist bumps/handshakes
...
- Emphasize "state-approved"
- Clear on "www.elevateforhumanity.org"
...
- Entrepreneurs wanting a skill-based business

---

## Key Selling Points to Emphasize

1. **State-Approved** - Legitimate pathway to licensure
2. **Earn While You Learn** - Get paid during training
3. **Real Shops** - Not just classroom, actual experience
4. **Limited Spots** - Creates urgency
5. **Build Your Brand** - Entrepreneurship angle
6. **Community** - Barbershop culture and mentorship
...
- Questions about shop locations
...
- Shares (especially to barber community)
...
- Accurate representation of earning potential
- Clear about apprenticeship vs. school distinction

---

**Created**: 2025-11-16  
**Status**: Ready for production  
**Priority**: High - Unique program differentiator  
**Target Launch**: ASAP - Limited spots messaging
