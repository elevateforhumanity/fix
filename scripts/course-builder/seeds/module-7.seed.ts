  ...
  lessons: [
    {
      ...
      competencyChecks: [
        { id: 'retention-strategies', type: 'KNOWLEDGE', description: 'Identifies at least 3 client retention strategies and explains the purpose of each', required: true },
        { id: 'client-card', type: 'KNOWLEDGE', description: 'Explains the purpose of a client card and what information to track', required: true },
        { id: 'rebook-recommendation', type: 'PROCEDURE', description: 'States the rebook recommendation at the end of service — every client, every time', required: true },
      ],
    },
    {
      ...
      competencyChecks: [
        { id: 'commission-model', type: 'KNOWLEDGE', description: 'Describes the commission model and its advantages for new barbers', required: true },
        { id: 'booth-rental-finances', type: 'KNOWLEDGE', description: 'Explains what booth rental means financially — revenue kept, expenses owned', required: true },
        { id: 'self-employment-tax', type: 'KNOWLEDGE', description: 'Identifies the tax obligations of a self-employed barber including self-employment tax rate', required: true },
      ],
    },
    {
      ...
      competencyChecks: [
        { id: 'price-research', type: 'KNOWLEDGE', description: 'Explains how to research and set competitive prices based on market and experience', required: true },
        { id: 'tip-standard', type: 'KNOWLEDGE', description: 'States the standard tip percentage for barbering (15–20%)', required: true },
        { id: 'quarterly-taxes', type: 'KNOWLEDGE', description: 'Explains the quarterly estimated tax requirement and consequence of non-payment', required: true },
      ],
    },
    {
      ...
      competencyChecks: [
        { id: 'barbers-code', type: 'KNOWLEDGE', description: 'States the four elements of the barber\'s code without prompting', required: true },
        { id: 'complaint-handling', type: 'PROCEDURE', description: 'Describes how to handle a client complaint professionally — calm, listen, offer to fix', required: true },
        { id: 'scope-of-practice', type: 'KNOWLEDGE', description: 'Identifies services outside the barber\'s scope of practice', required: true },
        { id: 'ce-requirement', type: 'KNOWLEDGE', description: 'States Indiana\'s continuing education requirement for license renewal', required: true },
      ],
    },
    {
      ...
      competencyChecks: [
        { id: 'product-identification', type: 'KNOWLEDGE', description: 'Identifies all five product types and their hold/finish characteristics', required: true },
        { id: 'product-selection', type: 'TECHNIQUE', description: 'Selects appropriate product based on hair type and desired finish', required: true },
        { id: 'application-technique', type: 'TECHNIQUE', description: 'Applies product correctly — warms between palms, works evenly through hair, does not over-apply', required: true },
      ],
    },
    {
      ...
      content: 'See sidecar.',
      competencyChecks: [
        { id: 'color-patch-test', type: 'SAFETY', description: 'Performs a patch test 24–48 hours before oxidative color application', required: true },
        { id: 'color-strand-test', type: 'TECHNIQUE', description: 'Performs a strand test to assess color result and processing time', required: true },
        { id: 'color-application', type: 'TECHNIQUE', description: 'Applies haircolor using correct sectioning and timing per manufacturer instructions', required: true },
        { id: 'color-ppe', type: 'SAFETY', description: 'Wears gloves and protective cape throughout color service', required: true },
      ],
    },
    {
      ...
      content: 'See sidecar.',
      competencyChecks: [
        { id: 'perm-test-curl', type: 'TECHNIQUE', description: 'Performs a test curl to assess processing time', required: true },
        { id: 'perm-neutralizer', type: 'TECHNIQUE', description: 'Applies neutralizer correctly after processing to re-harden disulfide bonds', required: true },
        { id: 'perm-contraindications', type: 'SAFETY', description: 'Identifies contraindications for chemical texture services', required: true },
        { id: 'perm-ppe', type: 'SAFETY', description: 'Wears appropriate PPE throughout chemical texture service', required: true },
      ],
    },
    {
      ...
      content: 'See sidecar.',
      competencyChecks: [
        { id: 'nail-anatomy', type: 'KNOWLEDGE', description: 'Identifies nail anatomy: plate, bed, lunula, cuticle, free edge', required: true },
        { id: 'nail-disorders', type: 'KNOWLEDGE', description: 'Identifies nail disorders that contraindicate nail services', required: true },
        { id: 'nail-sanitation', type: 'SAFETY', description: 'Demonstrates correct disinfection of metal nail implements between clients', required: true },
      ],
    },
  ],
  checkpoint: {
