  ...
  lessons: [
    {
      ...
      competencyChecks: [
        { id: 'color-wheel', type: 'KNOWLEDGE', description: 'Identifies primary, secondary, and complementary colors and states how complementary colors are used', required: true },
        { id: 'level-system', type: 'KNOWLEDGE', description: 'States the hair color level system (1–10) with correct color descriptions', required: true },
        { id: 'color-types', type: 'KNOWLEDGE', description: 'Distinguishes temporary, semi-permanent, demi-permanent, and permanent color by developer use and longevity', required: true },
      ],
    },
    {
      ...
      competencyChecks: [
        { id: 'patch-test-timing', type: 'PROCEDURE', description: 'Performs patch test 24–48 hours before chemical service — not the same day', required: true },
        { id: 'ppe-chemical', type: 'SAFETY', description: 'Wears nitrile gloves, apron, and eye protection during chemical services', required: true },
        { id: 'contraindication-chemical', type: 'SAFETY', description: 'Identifies all contraindications before proceeding and stops if any are present', required: true },
        { id: 'reaction-stop', type: 'SAFETY', description: 'Stops service if patch test shows any reaction — no exceptions', required: true },
      ],
    },
    {
      ...
      competencyChecks: [
        { id: 'disulfide-bonds', type: 'KNOWLEDGE', description: 'Explains how relaxers break disulfide bonds and what the neutralizer does', required: true },
        { id: 'lye-vs-nolye', type: 'KNOWLEDGE', description: 'Distinguishes lye from no-lye relaxers by chemistry and risk profile', required: true },
        { id: 'scalp-basing', type: 'PROCEDURE', description: 'States the scalp basing requirement and the rule against applying to a scratched scalp', required: true },
        { id: 'neutralizer-purpose', type: 'KNOWLEDGE', description: 'States the purpose of the neutralizer and consequence of insufficient neutralizing', required: true },
      ],
    },
    {
      ...
      competencyChecks: [
        { id: 'treatment-selection', type: 'TECHNIQUE', description: 'Selects correct treatment type for the client\'s scalp condition', required: true },
        { id: 'shampoo-first', type: 'PROCEDURE', description: 'Shampoos before applying treatment — correct sequence', required: true },
        { id: 'fingertip-massage', type: 'TECHNIQUE', description: 'Uses fingertip pressure — not fingernails — during scalp massage', required: true },
        { id: 'medical-referral', type: 'SAFETY', description: 'Refers client to physician when scalp condition is medical in nature', required: true },
      ],
    },
  ],
  checkpoint: {
