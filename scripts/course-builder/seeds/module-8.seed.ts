  ...
  lessons: [
    {
      ...
      competencyChecks: [
        { id: 'passing-score', type: 'KNOWLEDGE', description: 'States the written exam passing score (75%) without prompting', required: true },
        { id: 'topic-weights', type: 'KNOWLEDGE', description: 'Identifies the five topic areas and their approximate weights', required: true },
        { id: 'practical-criteria', type: 'KNOWLEDGE', description: 'Describes what the practical exam tests — draping, sanitation, fade, shave', required: true },
        { id: 'ojt-hours', type: 'KNOWLEDGE', description: 'States the OJT hour requirement for the apprenticeship path (2,000)', required: true },
      ],
    },
    {
      ...
      competencyChecks: [
        { id: 'between-client-requirement', type: 'KNOWLEDGE', description: 'States the between-client disinfection requirement — disinfection, not sterilization', required: true },
        { id: 'sharps-disposal-method', type: 'KNOWLEDGE', description: 'Identifies the correct sharps disposal method — puncture-resistant container', required: true },
        { id: 'hair-shaft-review', type: 'KNOWLEDGE', description: 'Names the three layers of the hair shaft and their functions from memory', required: true },
        { id: 'growth-cycle-review', type: 'KNOWLEDGE', description: 'States the three phases of the hair growth cycle with correct durations', required: true },
      ],
    },
    {
      ...
      competencyChecks: [
        { id: 'fade-reference-points', type: 'KNOWLEDGE', description: 'Identifies parietal ridge and occipital bone as fade reference points', required: true },
        { id: 'razor-angle-recall', type: 'KNOWLEDGE', description: 'States correct razor angle (30 degrees) without prompting', required: true },
        { id: 'apprenticeship-hours', type: 'KNOWLEDGE', description: 'Distinguishes apprenticeship hours (2,000) from school hours (1,500)', required: true },
        { id: 'written-passing-score', type: 'KNOWLEDGE', description: 'States the written exam passing score (75%) — not 70%', required: true },
      ],
    },
    {
      ...
      competencyChecks: [
        { id: 'draping-sequence', type: 'PROCEDURE', description: 'Drapes client correctly with neck strip before cape — no prompting needed', required: true },
        { id: 'sanitation-sequence-exam', type: 'SANITATION', description: 'Performs sanitation sequence in correct order before service — pre-clean → disinfect → contact time', required: true },
        { id: 'fade-execution', type: 'TECHNIQUE', description: 'Executes fade with smooth transitions and no visible lines', required: true },
        { id: 'shave-execution', type: 'TECHNIQUE', description: 'Performs shave with correct angle and grain direction', required: true },
        { id: 'post-service-cleanup', type: 'SANITATION', description: 'Cleans and disinfects station after service', required: true },
      ],
    },
    {
      ...
      content: 'See sidecar.',
      competencyChecks: [
        { id: 'style-thermal', type: 'TECHNIQUE', description: 'Uses thermal tools safely to create curl and wave patterns', required: true },
        { id: 'style-product', type: 'TECHNIQUE', description: 'Selects and applies appropriate styling products for desired texture result', required: true },
        { id: 'style-heat-safety', type: 'SAFETY', description: 'Demonstrates safe heat tool handling to prevent client burns', required: true },
      ],
    },
    {
      ...
      content: 'See sidecar.',
      competencyChecks: [
        { id: 'facial-massage-movements', type: 'TECHNIQUE', description: 'Performs the five massage movements: effleurage, petrissage, tapotement, friction, vibration', required: true },
        { id: 'facial-contraindications', type: 'SAFETY', description: 'Identifies contraindications for facial massage services', required: true },
        { id: 'facial-steam', type: 'TECHNIQUE', description: 'Uses facial steamer safely to prepare skin for treatment', required: true },
      ],
    },
    {
      ...
      content: 'See sidecar.',
      competencyChecks: [
        { id: 'biz-booth-rental', type: 'KNOWLEDGE', description: 'Explains the legal and tax differences between booth rental and employment', required: true },
        { id: 'biz-indiana-law', type: 'KNOWLEDGE', description: 'Identifies Indiana employment law requirements for barbershop workers', required: true },
        { id: 'biz-contracts', type: 'KNOWLEDGE', description: 'Describes key elements of a booth rental or employment contract', required: true },
      ],
    },
  ],
  checkpoint: {
