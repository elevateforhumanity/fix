...
-- ────────────────────────────────────────────────────────────────
-- 2. partner_courses (partner_lms_courses is a VIEW over this table)
-- ────────────────────────────────────────────────────────────────
ALTER TABLE IF EXISTS public.partner_courses ENABLE ROW LEVEL SECURITY;

DROP POLICY IF EXISTS "partner_courses_active_read" ON public.partner_courses;
CREATE POLICY "partner_courses_active_read"
...
-- ────────────────────────────────────────────────────────────────
-- 3. partner_courses (cleanup old policy names; policies already created in section 2)
-- ────────────────────────────────────────────────────────────────
...
DROP POLICY IF EXISTS "partner_certificates_own" ON public.partner_certificates;
...
DROP POLICY IF EXISTS "partner_certificates_admin" ON public.partner_certificates;
