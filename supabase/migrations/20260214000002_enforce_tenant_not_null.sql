...
DO $$ BEGIN
  ALTER TABLE profiles ADD CONSTRAINT profiles_tenant_id_not_null CHECK (tenant_id IS NOT NULL) NOT VALID;
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

DO $$ BEGIN
  ALTER TABLE training_enrollments ADD CONSTRAINT training_enrollments_tenant_id_not_null CHECK (tenant_id IS NOT NULL) NOT VALID;
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

DO $$ BEGIN
  ALTER TABLE certificates ADD CONSTRAINT certificates_tenant_id_not_null CHECK (tenant_id IS NOT NULL) NOT VALID;
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

DO $$ BEGIN
  ALTER TABLE lesson_progress ADD CONSTRAINT lesson_progress_tenant_id_not_null CHECK (tenant_id IS NOT NULL) NOT VALID;
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

DO $$ BEGIN
  ALTER TABLE apprentice_placements ADD CONSTRAINT placements_tenant_id_not_null CHECK (tenant_id IS NOT NULL) NOT VALID;
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

DO $$ BEGIN
  ALTER TABLE shops ADD CONSTRAINT shops_tenant_id_not_null CHECK (tenant_id IS NOT NULL) NOT VALID;
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

DO $$ BEGIN
  ALTER TABLE shop_staff ADD CONSTRAINT shop_staff_tenant_id_not_null CHECK (tenant_id IS NOT NULL) NOT VALID;
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;
